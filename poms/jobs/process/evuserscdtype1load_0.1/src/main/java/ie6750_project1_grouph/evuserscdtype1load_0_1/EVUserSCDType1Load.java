...
package ie6750_project1_grouph.evuserscdtype1load_0_1;
...
/**
 * Job: EVUserSCDType1Load Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class EVUserSCDType1Load implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "EVUserSCDType1Load.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(EVUserSCDType1Load.class);
	...
	private final String jobName = "EVUserSCDType1Load";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					EVUserSCDType1Load.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(EVUserSCDType1Load.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:HxTWAHwCQisftWjcbSfL/Sh3enwlYtNIvtC1wj7SY3+XpQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:AvOloD/NTvadNQpnahe5TMOt50q0Oee97UgChqcZgbux/w==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:/ZeSbSDV1z9UaXHw2aPmuvMJH/zISSe6ZbfsYb2EGPw6zA==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:z/KCgGwvXQ/eBIme0YtV8UIWQn42lYLqaDianOdpSyEY7w==");
	...
	public static class CityFoundStruct implements routines.system.IPersistableRow<CityFoundStruct> {
		final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load = new byte[0];
		static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load.length) {
					if (length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load.length == 0) {
						commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load = new byte[1024];
					} else {
						commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IE6750_PROJECT1_GROUPH_EVUserSCDType1Load) {
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBSCD_1", "\"evuser\"", "tPostgresqlSCD");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				if (dbSchema_tDBSCD_1 == null || dbSchema_tDBSCD_1.trim().length() == 0) {
					tableName_tDBSCD_1 = "evuser";
				} else {
					tableName_tDBSCD_1 = dbSchema_tDBSCD_1 + "\".\"" + "evuser";
				}
				java.sql.Timestamp timestamp_tDBSCD_1 = null;
				String tmpValue_tDBSCD_1 = null;
				String search_tDBSCD_1 = "SELECT \"userid\", \"birthdate\", \"fullname\", \"citykey\" FROM \""
						+ tableName_tDBSCD_1 + "\"";
				...
				while (resultSet_tDBSCD_1.next()) {
					...
					if (resultSet_tDBSCD_1.getObject(1) != null) {
						sk_tDBSCD_1.userid = resultSet_tDBSCD_1.getInt(1);
					}
					timestamp_tDBSCD_1 = resultSet_tDBSCD_1.getTimestamp(2);
					if (timestamp_tDBSCD_1 != null) {
						row_tDBSCD_1.birthdate = new java.util.Date(timestamp_tDBSCD_1.getTime());
					} else {
						row_tDBSCD_1.birthdate = null;
					}
					if (resultSet_tDBSCD_1.getObject(3) != null) {
						row_tDBSCD_1.fullname = resultSet_tDBSCD_1.getString(3);
					}
				...
				String insertionSQL_tDBSCD_1 = "INSERT INTO \"" + tableName_tDBSCD_1
						+ "\"(\"userkey\", \"userid\", \"birthdate\", \"fullname\", \"citykey\") VALUES(" + "nextval('"
...
// Start of branch "CityFound"
						if (CityFound != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "CityFound", "tMap_1", "tMap_1", "tMap", "tDBSCD_1", "\"evuser\"",
									"tPostgresqlSCD"
							...
							try {
								...
								lookUpKey_tDBSCD_1.userid = CityFound.userid;
								...
								if (lookUpValue_tDBSCD_1 == null) {
									...
									insertionStatement_tDBSCD_1.setInt(1, CityFound.userid);

									if (CityFound.birthdate == null) {
										insertionStatement_tDBSCD_1.setNull(2, java.sql.Types.TIMESTAMP);
									} else {
										if (CityFound.birthdate != null) {
											insertionStatement_tDBSCD_1.setTimestamp(2,
													new java.sql.Timestamp(CityFound.birthdate.getTime()));
										} else {
											insertionStatement_tDBSCD_1.setNull(2, java.sql.Types.TIMESTAMP);
										}
									}

									if (CityFound.fullname == null) {
										insertionStatement_tDBSCD_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										insertionStatement_tDBSCD_1.setString(3, CityFound.fullname);
									}

									insertionStatement_tDBSCD_1.setInt(4, CityFound.citykey);

									nb_line_inserted_tDBSCD_1 += insertionStatement_tDBSCD_1.executeUpdate();
								} else {
									if (lookUpValue_tDBSCD_1.citykey != CityFound.citykey) {
										updateForType1_tDBSCD_1.setInt(1, CityFound.citykey);

										updateForType1_tDBSCD_1.setInt(2, CityFound.userid);
							...
							lookUpValue_tDBSCD_1.citykey = CityFound.citykey;
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "CityFound", 2, 0,
						"tMap_1", "tMap_1", "tMap", "tDBSCD_1", "\"evuser\"", "tPostgresqlSCD", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final EVUserSCDType1Load EVUserSCDType1LoadClass = new EVUserSCDType1Load();

		int exitCode = EVUserSCDType1LoadClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'EVUserSCDType1Load' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'EVUserSCDType1Load' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_R_o7sJ49Ee-X4vy2Pd8MIA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-09T19:59:45.191284Z");
		...
		try {
			...
			java.io.InputStream inContext = EVUserSCDType1Load.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/evuserscdtype1load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = EVUserSCDType1Load.class.getClassLoader()
		...
		log.info("TalendJob: 'EVUserSCDType1Load' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : EVUserSCDType1Load");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'EVUserSCDType1Load' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 186221 characters generated by Talend Real-time Big Data Platform on the 9
 * November 2024 at 20:59:45 CET
 ************************************************************************************************/