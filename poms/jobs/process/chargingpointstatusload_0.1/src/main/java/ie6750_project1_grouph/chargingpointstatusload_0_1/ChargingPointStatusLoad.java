...
package ie6750_project1_grouph.chargingpointstatusload_0_1;
...
/**
 * Job: ChargingPointStatusLoad Purpose: <br>
 * Description:  <br>
 * @author lin.shan1@northeastern.edu
 * @version 8.0.1.20240920_1319-patch
 * @status 
 */
public class ChargingPointStatusLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "ChargingPointStatusLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(ChargingPointStatusLoad.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ChargingPointStatusLoad";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Uo97IJvcEe-5PpigxqfS-w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ChargingPointStatusLoad.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ChargingPointStatusLoad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:Ug8PQqGfprWtsAk6kprQ68AhWFokDdhJDYAcsZqDYvcD9w==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:xDf6+qY650hGH/ivfylP06t+iDTD+8NB5v7Izpspaty89g==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:EoHipzD6s8w7eS2MetYltyBxPfcxJBDTOLdVp55vVpuDtQ==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:J8PeIiDv7V55Nj4CjQKg1Hw0Eyv+0TCjrIDuFIDyHcUxEw==");
...
public static class FoundStruct implements routines.system.IPersistableRow<FoundStruct> {
    final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad = new byte[0];
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.chargingpointstatuskey;
	...
	public boolean equals(Object obj) {
		...
		final FoundStruct other = (FoundStruct) obj;
						...
						if (this.chargingpointstatuskey != other.chargingpointstatuskey)
							return false;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad.length) {
				if(length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad.length == 0) {
   					commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad = new byte[1024];
				} else {
   					commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_ChargingPointStatusLoad) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.statusdescription = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.statusdescription,dos);
    ...
    public int compareTo(FoundStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.chargingpointstatuskey, other.chargingpointstatuskey);
						if(returnValue != 0) {
							return returnValue;
						}
...
NotFoundStruct NotFound = new NotFoundStruct();
	...
	s(currentComponent="tDBOutput_1");
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"chargingpointstatus\"");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"chargingpointstatus\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("chargingpointstatus");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("chargingpointstatus");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"chargingpointstatusid\" = ?,\"statusdescription\" = ? WHERE \"chargingpointstatuskey\" = ?";
 ...
 */
	...
	s(currentComponent="tDBOutput_2");
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"chargingpointstatus\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("chargingpointstatuskey")+", NAME="+("\"chargingpointstatuskey\"")+", SQL="+("\"nextval('chargingpointstatus_chargingpointstatuskey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"chargingpointstatus\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("chargingpointstatus");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("chargingpointstatus");
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "chargingpointstatuskey" + "\",\"chargingpointstatusid\",\"statusdescription\") VALUES (" + "nextval('chargingpointstatus_chargingpointstatuskey_seq')" + ",?,?)");
 ...
 */
	...
	s(currentComponent="tDBInput_1");
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"chargingpointstatus\\\".\\\"statusid\\\",    \\\"chargingpointstatus\\\".\\\"statusdescription\\\"  FROM \\\"chargingpointstatus\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("statusid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("statusdescription")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "\"chargingpointstatus\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
+"tatus\"";
            ...
            row1.statusid = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.statusdescription = null;
							} else {
	                         		
        	row1.statusdescription = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
 ...
 */
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","\"chargingpointstatus\"","tPostgresqlInput","tMap_1","tMap_1","tMap"
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.chargingpointstatusid = row1.statusid ;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.chargingpointstatusid = '" + row2HashKey.chargingpointstatusid + "'");
								} // G 071
...
Found_tmp.chargingpointstatuskey = row2.chargingpointstatuskey;
Found_tmp.chargingpointstatusid = row2.chargingpointstatusid;
Found_tmp.statusdescription = row1.statusdescription;
Found = Found_tmp;
...
NotFound_tmp.chargingpointstatuskey = 0;
NotFound_tmp.chargingpointstatusid = row1.statusid ;
NotFound_tmp.statusdescription = row1.statusdescription;
...
if(Found != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found","tMap_1","tMap_1","tMap","tDBOutput_1","\"chargingpointstatus\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    if(Found.chargingpointstatusid == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, Found.chargingpointstatusid);
}

                    if(Found.statusdescription == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, Found.statusdescription);
}

                    pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, Found.chargingpointstatuskey);
...
if(NotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tDBOutput_2","\"chargingpointstatus\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    if(NotFound.chargingpointstatusid == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, NotFound.chargingpointstatusid);
}

                    if(NotFound.statusdescription == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, NotFound.statusdescription);
}
...
// ###############################      
				...
				log.debug("tMap_1 - Written records count in the table 'NotFound': " + count_NotFound_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","\"chargingpointstatus\"","tPostgresqlInput","tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Found",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_1","\"chargingpointstatus\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"NotFound",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_2","\"chargingpointstatus\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"ChargingPointStatus Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","ChargingPointStatus Load is done!","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("ChargingPointStatus Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "ChargingPointStatus Load is done!"); 
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.chargingpointstatusid == null) ? 0 : this.chargingpointstatusid.hashCode());
 ...
 */
	...
	s(currentComponent="tDBInput_2");
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    \\\"chargingpointstatus\\\".\\\"chargingpointstatuskey\\\",    \\\"chargingpointstatus\\\".\\\"chargingpointstatusid\\\",    \\\"chargingpointstatus\\\".\\\"statusdescription\\\"  FROM \\\"chargingpointstatus\\\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("chargingpointstatuskey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("chargingpointstatusid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("statusdescription")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_2", "\"chargingpointstatus\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row2.chargingpointstatuskey = 0;
							} else {
		                          
            row2.chargingpointstatuskey = rs_tDBInput_2.getInt(1);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row2.chargingpointstatusid = null;
							} else {
		                          
            row2.chargingpointstatusid = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    row2.chargingpointstatusid = null;
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row2.statusdescription = null;
							} else {
	                         		
        	row2.statusdescription = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"chargingpointstatus\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
				...
				row2_HashRow.chargingpointstatusid = row2.chargingpointstatusid;
				
				row2_HashRow.statusdescription = row2.statusdescription;
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"chargingpointstatus\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final ChargingPointStatusLoad ChargingPointStatusLoadClass = new ChargingPointStatusLoad();

        int exitCode = ChargingPointStatusLoadClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'ChargingPointStatusLoad' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'ChargingPointStatusLoad' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_Uo97IJvcEe-5PpigxqfS-w");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:04.646070Z");
        ...
        try {
            ...
            java.io.InputStream inContext = ChargingPointStatusLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/chargingpointstatusload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ChargingPointStatusLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'ChargingPointStatusLoad' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ChargingPointStatusLoad");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'ChargingPointStatusLoad' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     181805 characters generated by Talend Real-time Big Data Platform 
