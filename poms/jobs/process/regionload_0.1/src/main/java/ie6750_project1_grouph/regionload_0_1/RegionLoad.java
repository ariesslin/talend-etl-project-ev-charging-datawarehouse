...
package ie6750_project1_grouph.regionload_0_1;
...
/**
 * Job: RegionLoad Purpose: <br>
 * Description:  <br>
 * @author lin.shan1@northeastern.edu
 * @version 8.0.1.20240920_1319-patch
 * @status 
 */
public class RegionLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "RegionLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(RegionLoad.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "RegionLoad";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_XkOAkJu2Ee-5PpigxqfS-w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(RegionLoad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:KFxPQK+Ugd0j6zhi7TqiFCPbUCagHVxmBeVXDI0b3mZLyA==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tSYvX3CkD0uCaTVLWKG0SPL7wd4+nCjtekDJIzvqg4NEBw==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:GvPXkb4rMH3hCIIU8IAAv18m60zFx1YlyFLEWGsSI/qqNw==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FS4Ud/oyEwqif1wtSu5/CYd7Jgq//3C1BjG5mdaaUsRTdA==");
...
public static class FoundStruct implements routines.system.IPersistableRow<FoundStruct> {
    final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_RegionLoad = new byte[0];
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.regionkey;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad.length) {
				if(length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad.length == 0) {
   					commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad = new byte[1024];
				} else {
   					commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_RegionLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_RegionLoad) {
    ...
    public int compareTo(FoundStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.regionkey, other.regionkey);
						if(returnValue != 0) {
							return returnValue;
						}
...
NotFoundStruct NotFound = new NotFoundStruct();
	...
	s(currentComponent="tDBOutput_1");
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"region\"");
                        log4jParamters_tDBOutput_1.append(" | ");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("regionkey")+", NAME="+("\"regionkey\"")+", SQL="+("\"nextval('region_regionkey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"region\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("region");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("region");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"regionname\" = ? WHERE \"" + "regionkey" + "\" = " + "nextval('region_regionkey_seq')" + "";
 ...
 */
	...
	s(currentComponent="tDBOutput_2");
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"region\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("regionkey")+", NAME="+("\"regionkey\"")+", SQL="+("\"nextval('region_regionkey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"region\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("region");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("region");
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "regionkey" + "\",\"regionname\") VALUES (" + "nextval('region_regionkey_seq')" + ",?)");
 ...
 */
	...
	s(currentComponent="tFileInputXML_1");
		...
		int tos_count_tFileInputXML_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputXML_1{
                    ...
                    log4jParamters_tFileInputXML_1.append("Parameters:");
                            log4jParamters_tFileInputXML_1.append("FILENAME" + " = " + "\"/Users/ariesslin/Downloads/Italian-regions.xml\"");
                        log4jParamters_tFileInputXML_1.append(" | ");
                            log4jParamters_tFileInputXML_1.append("LOOP_QUERY" + " = " + "\"/qgis_style/legendpatchshapes/legendpatchshape\"");
                        log4jParamters_tFileInputXML_1.append(" | ");
                            log4jParamters_tFileInputXML_1.append("MAPPING" + " = " + "[{QUERY="+("\"@name\"")+", NODECHECK="+("")+", SCHEMA_COLUMN="+("name")+"}]");
                        log4jParamters_tFileInputXML_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileInputXML_1", "xmlRegion", "tFileInputXML");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
try {
	filename_tFileInputXML_1 = "/Users/ariesslin/Downloads/Italian-regions.xml";
} catch(java.lang.Exception e) {
...
org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1.createXPath(nsTool_tFileInputXML_1.addDefaultNSPrefix("/qgis_style/legendpatchshapes/legendpatchshape"));  
...
java.util.Map<Integer,org.dom4j.XPath> xpaths_tFileInputXML_1=new java.util.HashMap<Integer,org.dom4j.XPath>();
	...
	org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("@name","/qgis_style/legendpatchshapes/legendpatchshape"));
...
if(row1 != null) { 
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tFileInputXML_1","xmlRegion","tFileInputXML","tMap_1","tMap_1","tMap"
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.regionname = row1.name ;
...
Found_tmp.regionkey = row2.regionkey;
Found_tmp.regionname = row2.regionname;
Found = Found_tmp;
...
NotFound_tmp.regionkey = 0;
NotFound_tmp.regionname = row1.name ;
...
if(Found != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found","tMap_1","tMap_1","tMap","tDBOutput_1","\"region\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    if(Found.regionname == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, Found.regionname);
}
...
if(NotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tDBOutput_2","\"region\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    if(NotFound.regionname == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, NotFound.regionname);
}
...
// ###############################      
				...
				log.debug("tMap_1 - Written records count in the table 'NotFound': " + count_NotFound_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tFileInputXML_1","xmlRegion","tFileInputXML","tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Found",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_1","\"region\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"NotFound",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_2","\"region\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"Region Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Region Load is done!","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("Region Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "Region Load is done!"); 
		...
		int tos_count_tAdvancedHash_row2 = 0;
			...
			if(enableLogStash) {
				...
				s(currentComponent);
			   		...
			   		// source node:tDBInput_1 - inputs:(after_tFileInputXML_1) outputs:(row2,row2) | target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
 ...
 */
	...
	s(currentComponent="tDBInput_1");
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"region\\\".\\\"regionkey\\\",    \\\"region\\\".\\\"regionname\\\"  FROM \\\"region\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("regionkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("regionname")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
            ...
            row2.regionkey = rs_tDBInput_1.getInt(1);
        	...
        	row2.regionname = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_1","\"region\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_1","\"region\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final RegionLoad RegionLoadClass = new RegionLoad();

        int exitCode = RegionLoadClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'RegionLoad' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'RegionLoad' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_XkOAkJu2Ee-5PpigxqfS-w");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:03.728140Z");
        ...
        try {
            ...
            java.io.InputStream inContext = RegionLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/regionload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = RegionLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'RegionLoad' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RegionLoad");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'RegionLoad' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     173923 characters generated by Talend Real-time Big Data Platform 
