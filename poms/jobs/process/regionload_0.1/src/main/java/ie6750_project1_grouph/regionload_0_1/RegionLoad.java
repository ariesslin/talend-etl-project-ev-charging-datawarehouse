...
public class RegionLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "RegionLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(RegionLoad.class);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:TltNmIONj+B/8tn9VJLyCc5eVmXNzFUcqHccKC+xt8n8AA==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:k8wxPevKeOaa69TCvCVYsFV9/zKCQ5XkwStdT3o4uLrsGw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:0XwZjDdzeUkW/BjZvqAHKRmBLJRyNDQq73U9VT+7i5GdFg==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:iwNPs7VtOxW2uiMVgSwTpeY1gIdLnWZEspMEQ2Q+DOuo9Q==");
	...
	public void tFileInputXML_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("regionkey") + ", NAME=" + ("\"regionkey\"") + ", SQL="
									+ ("\"nextval('region_regionkey_seq')\"") + "}]");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"regionname\" = ? WHERE \""
						+ "regionkey" + "\" = " + "nextval('region_regionkey_seq')" + "";
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "regionkey"
						+ "\",\"regionname\") VALUES (" + "nextval('region_regionkey_seq')" + ",?)");
...
// ###############################
					...
					class BytesLimit65535_tFileInputXML_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputXML_1
									.append("FILENAME" + " = " + "\"/Users/ariesslin/Downloads/Italian-regions.xml\"");
							log4jParamters_tFileInputXML_1.append(" | ");
							log4jParamters_tFileInputXML_1.append(
									"LOOP_QUERY" + " = " + "\"/qgis_style/legendpatchshapes/legendpatchshape\"");
							log4jParamters_tFileInputXML_1.append(" | ");
							log4jParamters_tFileInputXML_1.append("MAPPING" + " = " + "[{QUERY=" + ("\"@name\"")
									+ ", NODECHECK=" + ("") + ", SCHEMA_COLUMN=" + ("name") + "}]");
							log4jParamters_tFileInputXML_1.append(" | ");
				...
				if (isValidFile_tFileInputXML_1) {
					...
					org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1.createXPath(nsTool_tFileInputXML_1
							.addDefaultNSPrefix("/qgis_style/legendpatchshapes/legendpatchshape"));
...
//init all mapping xpaths
					...
					class XPathUtil_tFileInputXML_1 {
						...
						public void initXPaths_0(java.util.Map<Integer, org.dom4j.XPath> xpaths,
							...
							org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper.createXPath(nsTool
									.addDefaultNSPrefix("@name", "/qgis_style/legendpatchshapes/legendpatchshape"));
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputXML_1", "xmlRegion", "tFileInputXML", "tMap_1", "tMap_1",
									"tMap"
...
// Start of branch "Found"
							if (Found != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "Found", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "\"region\"",
										"tPostgresqlOutput"
								...
								if (Found.regionname == null) {
									...
									pstmt_tDBOutput_1.setString(1, Found.regionname);
								}
...
// Start of branch "NotFound"
							if (NotFound != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "NotFound", "tMap_1", "tMap_1", "tMap", "tDBOutput_2", "\"region\"",
										"tPostgresqlOutput"
								...
								if (NotFound.regionname == null) {
									...
									pstmt_tDBOutput_2.setString(1, NotFound.regionname);
								}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Found", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "\"region\"", "tPostgresqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_1 - inputs:(after_tFileInputXML_1) outputs:(row2,row2) |
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_1", "\"region\"", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_1", "\"region\"", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T23:07:18.009356Z");
		...
		try {
			...
			java.io.InputStream inContext = RegionLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/regionload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = RegionLoad.class.getClassLoader()
...
/************************************************************************************************
 * 169000 characters generated by Talend Real-time Big Data Platform on the 7
 * November 2024 at 00:07:18 CET
 ************************************************************************************************/