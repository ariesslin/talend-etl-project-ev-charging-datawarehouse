...
public class PricingModelLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "PricingModelLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(PricingModelLoad.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_iiqO0JvcEe-5PpigxqfS-w", "0.1");
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:UfLpyA5jyrVpCoII6iUKY3EWi20LB54C/k93noDGBZ20sw==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2pA2vkr5dArIGv1mN/94kd5c/JsNAihUFVytnMCgbPSflg==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:Ub8APmDLTnpGDcE9cMR8VnZQ78Uvj/dc3/YK+c/3USwP4w==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Eq3tIIzjfhCVlY6j5xlICyOXM8PlMCvguS9q3wMAN22jdQ==");
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"pricingmodelid\" = ?,\"rateperkwh\" = ?,\"peakstarttime\" = ?,\"peakendtime\" = ?,\"peakmultiplier\" = ? WHERE \"pricingmodelkey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("pricingmodelkey")+", NAME="+("\"pricingmodelkey\"")+", SQL="+("\"nextval('pricingmodel_pricingmodelkey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "pricingmodelkey" + "\",\"pricingmodelid\",\"rateperkwh\",\"peakstarttime\",\"peakendtime\",\"peakmultiplier\") VALUES (" + "nextval('pricingmodel_pricingmodelkey_seq')" + ",?,?,?,?,?)");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"pricingmodel\\\".\\\"pricingmodelid\\\",    \\\"pricingmodel\\\".\\\"rateperkwh\\\",    \\\"pricingmodel\\\".\\\"peakstarttime\\\",    \\\"pricingmodel\\\".\\\"peakendtime\\\",    \\\"pricingmodel\\\".\\\"peakmultiplier\\\"  FROM \\\"pricingmodel\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("pricingmodelid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("rateperkwh")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("peakstarttime")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("peakendtime")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("peakmultiplier")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
 ...
 */
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","\"pricingmodel\"","tPostgresqlInput","tMap_1","tMap_1","tMap"
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.pricingmodelid = '" + row2HashKey.pricingmodelid + "'");
								} // G 071
...
if(Found != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found","tMap_1","tMap_1","tMap","tDBOutput_1","\"pricingmodel\"","tPostgresqlOutput"
...
} else {pstmt_tDBOutput_1.setInt(1, Found.pricingmodelid);
}

                    pstmt_tDBOutput_1.setBigDecimal(2, Found.rateperkwh);

                    if(Found.peakstarttime != null) {
pstmt_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(Found.peakstarttime.getTime()));
} else {
...
if(NotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tDBOutput_2","\"pricingmodel\"","tPostgresqlOutput"
...
} else {pstmt_tDBOutput_2.setInt(1, NotFound.pricingmodelid);
}

                    pstmt_tDBOutput_2.setBigDecimal(2, NotFound.rateperkwh);

                    if(NotFound.peakstarttime != null) {
pstmt_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(NotFound.peakstarttime.getTime()));
} else {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(NotFound.peakendtime != null) {
pstmt_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(NotFound.peakendtime.getTime()));
} else {
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Found",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_1","\"pricingmodel\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"PricingModel Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","PricingModel Load is done!","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("PricingModel Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "PricingModel Load is done!"); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    \\\"pricingmodel\\\".\\\"pricingmodelkey\\\",    \\\"pricingmodel\\\".\\\"pricingmodelid\\\",    \\\"pricingmodel\\\".\\\"rateperkwh\\\",    \\\"pricingmodel\\\".\\\"peakstarttime\\\",    \\\"pricingmodel\\\".\\\"peakendtime\\\",    \\\"pricingmodel\\\".\\\"peakmultiplier\\\"  FROM \\\"pricingmodel\\\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("pricingmodelkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("pricingmodelid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("rateperkwh")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("peakstarttime")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("peakendtime")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("peakmultiplier")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"pricingmodel\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"pricingmodel\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'PricingModelLoad' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:04.991093Z");
        ...
        try {
            ...
            java.io.InputStream inContext = PricingModelLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/pricingmodelload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PricingModelLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PricingModelLoad");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     199035 characters generated by Talend Real-time Big Data Platform 
