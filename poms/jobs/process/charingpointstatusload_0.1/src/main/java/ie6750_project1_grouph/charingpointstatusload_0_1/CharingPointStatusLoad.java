...
package ie6750_project1_grouph.charingpointstatusload_0_1;
...
/**
 * Job: CharingPointStatusLoad Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class CharingPointStatusLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "CharingPointStatusLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(CharingPointStatusLoad.class);
	...
	private final String jobName = "CharingPointStatusLoad";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CharingPointStatusLoad.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CharingPointStatusLoad.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:SdIXDVvpP5RaF4kGPC7DqjtncvLhIdINktCb+byhvSauZg==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jv631g5VyFj4xZxfqCuUfB+sSl+uknkiZEk76aThNqXHWw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:fkyZz9v0WHk+M6pCWpyjcpDbGt2rJWOsfx1vicIhQTwiBQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:cPBBXfjrN6Z9O9NDLG6cJ/1ZAO7WrVSGblR+vB7DM4Zgnw==");
	...
	public static class FoundStruct implements routines.system.IPersistableRow<FoundStruct> {
		final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad = new byte[0];
		static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad.length) {
					if (length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad.length == 0) {
						commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad = new byte[1024];
					} else {
						commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IE6750_PROJECT1_GROUPH_CharingPointStatusLoad) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"chargingpointstatusid\" = ?,\"statusdescription\" = ? WHERE \"chargingpointstatuskey\" = ?";
					...
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("chargingpointstatuskey") + ", NAME=" + ("\"chargingpointstatuskey\"") + ", SQL="
									+ ("\"nextval('chargingpointstatus_chargingpointstatuskey_seq')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2)
						.append("\" (\"" + "chargingpointstatuskey"
								+ "\",\"chargingpointstatusid\",\"statusdescription\") VALUES ("
								+ "nextval('chargingpointstatus_chargingpointstatuskey_seq')" + ",?,?)");
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"chargingpointstatus\\\".\\\"statusid\\\",    \\\"chargingpointstatus\\\".\\\"statusdescription\\\"  FROM \\\"chargingpointstatus\\\"\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"chargingpointstatus\"", "tPostgresqlInput", "tMap_1",
								"tMap_1", "tMap"
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.chargingpointstatusid = '" +
							// row2HashKey.chargingpointstatusid + "'");
						} // G 071
...
// Start of branch "Found"
						if (Found != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "Found", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "\"chargingpointstatus\"",
									"tPostgresqlOutput"
							...
							if (Found.chargingpointstatusid == null) {
								...
								pstmt_tDBOutput_1.setInt(1, Found.chargingpointstatusid);
							}

							if (Found.statusdescription == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, Found.statusdescription);
							}
...
// Start of branch "NotFound"
						if (NotFound != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "NotFound", "tMap_1", "tMap_1", "tMap", "tDBOutput_2", "\"chargingpointstatus\"",
									"tPostgresqlOutput"
							...
							if (NotFound.chargingpointstatusid == null) {
								...
								pstmt_tDBOutput_2.setInt(1, NotFound.chargingpointstatusid);
							}

							if (NotFound.statusdescription == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, NotFound.statusdescription);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"chargingpointstatus\"", "tPostgresqlInput", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Found", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "\"chargingpointstatus\"", "tPostgresqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "NotFound", 2, 0,
						"tMap_1", "tMap_1", "tMap", "tDBOutput_2", "\"chargingpointstatus\"", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"chargingpointstatus\"", "tPostgresqlInput",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"chargingpointstatus\"", "tPostgresqlInput", "tAdvancedHash_row2",
	...
	public static void main(String[] args) {
		final CharingPointStatusLoad CharingPointStatusLoadClass = new CharingPointStatusLoad();

		int exitCode = CharingPointStatusLoadClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'CharingPointStatusLoad' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'CharingPointStatusLoad' - Start.");
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T22:56:41.621803Z");
		...
		try {
			...
			java.io.InputStream inContext = CharingPointStatusLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/charingpointstatusload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CharingPointStatusLoad.class.getClassLoader()
		...
		log.info("TalendJob: 'CharingPointStatusLoad' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : CharingPointStatusLoad");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'CharingPointStatusLoad' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 176742 characters generated by Talend Real-time Big Data Platform on the 6
 * November 2024 at 23:56:41 CET
 ************************************************************************************************/