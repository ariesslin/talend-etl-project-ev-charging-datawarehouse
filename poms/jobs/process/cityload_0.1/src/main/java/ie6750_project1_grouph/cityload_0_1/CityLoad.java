...
public class CityLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "CityLoad.log");
	}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:LmSvLrwSajsJR2OFS66zo/iN6rtFfb/DtN613N0vhRZtbQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:GiyIXjggLKby+CVqyXHdeq19L8lDhpVxoFJXOYZZVY3h+w==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:I0vOa9LY22RDUsTFX2KEdoY1aPCH+Ajtm0wZL3Q/O4UIrQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:trGWraaXyTRuYI3dtXcOQLZQ3Zpxhbw14qF0S54E6XCMNg==");
	...
	public static class RegionFoundStruct implements routines.system.IPersistableRow<RegionFoundStruct> {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final RegionFoundStruct other = (RegionFoundStruct) obj;
		...
		public void copyDataTo(RegionFoundStruct other) {
		...
		public void copyKeysDataTo(RegionFoundStruct other) {
	...
	public static class RegionNotFoundStruct implements routines.system.IPersistableRow<RegionNotFoundStruct> {
		final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_CityLoad = new byte[0];
		static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_CityLoad = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final RegionNotFoundStruct other = (RegionNotFoundStruct) obj;
		...
		public void copyDataTo(RegionNotFoundStruct other) {
		...
		public void copyKeysDataTo(RegionNotFoundStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(RegionNotFoundStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_1", "vPy9Sv_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"cityname\" = ?,\"regionkey\" = ? WHERE \"citykey\" = ?";
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append(
									"ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL=" + ("citykey") + ", NAME="
											+ ("\"citykey\"") + ", SQL=" + ("\"nextval('city_citykey_seq')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "citykey"
						+ "\",\"cityname\",\"regionkey\") VALUES (" + "nextval('city_citykey_seq')" + ",?,?)");
...
///////////////////////    			
				...
				runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, 0, 0, "RegionNotFound");
					...
					class BytesLimit65535_tWarn_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tWarn_1.append("MESSAGE" + " = "
									+ "\"Warning: Region not found for City '\" + RegionNotFound.cityname + \"'. Please verify the region data.\"");
...
// # Outputs initialization
				...
				int count_RegionNotFound_tMap_1 = 0;

				RegionNotFoundStruct RegionNotFound_tmp = new RegionNotFoundStruct();
// ###############################
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1
									.append("FILENAME" + " = " + "\"/Users/ariesslin/Downloads/itac.csv\"");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									...
									+ ("lat") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("lng") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("country") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("iso2") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("admin_name") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("capital")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("population") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("population_proper") + "}]");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"/Users/ariesslin/Downloads/itac.csv"/** End field tFileInputDelimited_1:FILENAME */
				;
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.lat = ParserUtils.parseTo_Float(
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.lng = ParserUtils.parseTo_Float(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.population = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.population_proper = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row1", "tFileInputDelimited_1", "ItalyCities", "tFileInputDelimited", "tMap_1",
									"tMap_1", "tMap"
							...
							if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row2.regionname = '" +
								// row2HashKey.regionname + "'");
							} // G 071
...
// # Output table : 'RegionFound'
									...
									log.debug("tMap_1 - Outputting the record " + count_RegionFound_tMap_1
											+ " of the output table 'RegionFound'.");

								} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'RegionNotFound'
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									count_RegionNotFound_tMap_1++;

									RegionNotFound_tmp.citykey = 0;
									RegionNotFound_tmp.cityname = row1.city;
									RegionNotFound_tmp.regionkey = null;
									RegionNotFound = RegionNotFound_tmp;
									log.debug("tMap_1 - Outputting the record " + count_RegionNotFound_tMap_1
											+ " of the output table 'RegionNotFound'.");
...
// Start of branch "RegionFound"
							if (RegionFound != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "RegionFound", "tMap_1", "tMap_1", "tMap", "tLogRow_1", "tLogRow_1", "tLogRow"
								...
								if (log.isTraceEnabled()) {
									log.trace(
											"RegionFound - " + (RegionFound == null ? "" : RegionFound.toLogString()));
								}
...
///////////////////////		
								...
								strBuffer_tLogRow_1.append(String.valueOf(RegionFound.citykey));

								strBuffer_tLogRow_1.append("|");

								if (RegionFound.cityname != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(RegionFound.cityname));

								} //

								strBuffer_tLogRow_1.append("|");

								if (RegionFound.regionkey != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(RegionFound.regionkey));
...
///////////////////////    			
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row3", "tLogRow_1", "tLogRow_1", "tLogRow", "tMap_2", "tMap_2", "tMap"
								...
								if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
									...
									row4HashKey.cityname = row3.cityname;
								...
								if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									// and it contains more one result from keys : row4.cityname = '" +
									// row4HashKey.cityname + "'");
								} // G 071
...
// # Output table : 'CityFound'
										...
										CityFound_tmp.cityname = row4.cityname;
										CityFound_tmp.regionkey = row3.regionkey;
										CityFound = CityFound_tmp;
										log.debug("tMap_2 - Outputting the record " + count_CityFound_tMap_2
...
// # Filter conditions 
									if (rejectedInnerJoin_tMap_2) {
										...
										CityNotFound_tmp.cityname = row3.cityname;
										CityNotFound_tmp.regionkey = row3.regionkey;
										CityNotFound = CityNotFound_tmp;
										log.debug("tMap_2 - Outputting the record " + count_CityNotFound_tMap_2
...
// Start of branch "CityFound"
								if (CityFound != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "CityFound", "tMap_2", "tMap_2", "tMap", "tDBOutput_1", "\"city\"",
											"tPostgresqlOutput"
									...
									if (CityFound.cityname == null) {
										...
										pstmt_tDBOutput_1.setString(1, CityFound.cityname);
									}

									if (CityFound.regionkey == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(2, CityFound.regionkey);
									}
...
// Start of branch "CityNotFound"
								if (CityNotFound != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "CityNotFound", "tMap_2", "tMap_2", "tMap", "tDBOutput_2", "\"city\"",
											"tPostgresqlOutput"
									...
									if (log.isTraceEnabled()) {
										log.trace("CityNotFound - "
												+ (CityNotFound == null ? "" : CityNotFound.toLogString()));
									}
									...
									if (CityNotFound.cityname == null) {
										...
										pstmt_tDBOutput_2.setString(1, CityNotFound.cityname);
									}

									if (CityNotFound.regionkey == null) {
										pstmt_tDBOutput_2.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(2, CityNotFound.regionkey);
									}
...
// Start of branch "RegionNotFound"
							if (RegionNotFound != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "RegionNotFound", "tMap_1", "tMap_1", "tMap", "tWarn_1", "tWarn_1", "tWarn"
								...
								if (log.isTraceEnabled()) {
									log.trace("RegionNotFound - "
											+ (RegionNotFound == null ? "" : RegionNotFound.toLogString()));
								}
								...
								try {
									...
									resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "",
											...
											"Warning: Region not found for City '" + RegionNotFound.cityname
													+ "'. Please verify the region data.",
											"", "");
									log.warn("tWarn_1 - "
											+ ("Message: ") + ("Warning: Region not found for City '"
													+ RegionNotFound.cityname + "'. Please verify the region data.")
											+ (". Code: ") + (42));
									globalMap.put("tWarn_1_WARN_MESSAGES", "Warning: Region not found for City '"
											+ RegionNotFound.cityname + "'. Please verify the region data.");
...
// ###############################      
				log.debug(
						"tMap_1 - Written records count in the table 'RegionFound': " + count_RegionFound_tMap_1 + ".");
				log.debug("tMap_1 - Written records count in the table 'RegionNotFound': " + count_RegionNotFound_tMap_1
						+ ".");

				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tFileInputDelimited_1", "ItalyCities", "tFileInputDelimited", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tMap_2", "tMap_2", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "RegionNotFound", 2, 0,
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(RegionFound,RegionNotFound)
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"region\"", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"region\"", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_2 - inputs:(row3,row4) outputs:(CityFound,CityNotFound)
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row4", "tDBInput_1", "\"city\"", "tPostgresqlInput", "tAdvancedHash_row4",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tDBInput_1", "\"city\"", "tPostgresqlInput", "tAdvancedHash_row4", "tAdvancedHash_row4",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T22:58:32.062867Z");
		...
		try {
			...
			java.io.InputStream inContext = CityLoad.class.getClassLoader()
					.getResourceAsStream("ie6750_project1_grouph/cityload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CityLoad.class.getClassLoader()
...
/************************************************************************************************
 * 277903 characters generated by Talend Real-time Big Data Platform on the 6
 * November 2024 at 23:58:32 CET
 ************************************************************************************************/