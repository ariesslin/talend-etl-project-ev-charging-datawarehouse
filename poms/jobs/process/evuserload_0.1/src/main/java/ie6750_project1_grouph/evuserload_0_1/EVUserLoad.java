...
public class EVUserLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "EVUserLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(EVUserLoad.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_XxaSwJvcEe-5PpigxqfS-w", "0.1");
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:ct3AJ6/49NiIt+eASf2Cx+h5Be6eiSETWkLLWUzZukXImA==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:xCf6ohg5LqGjF8yA9z7+qpsuqoWPl/JOMtcC9NnmOtqyJg==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:afcsY7nTfj90VHP67qF1A4P5/xDP6oTWyp3Q5nzHKV3SKA==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2yJuXaTNk1UQNOANMy/ziqqePf4VUDo2yP0pjzPsuQ4+Cw==");
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"userid\" = ?,\"fullname\" = ?,\"birthdate\" = ?,\"citykey\" = ? WHERE \"userkey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("userkey")+", NAME="+("\"userkey\"")+", SQL="+("\"nextval('evuser_userkey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "userkey" + "\",\"userid\",\"fullname\",\"birthdate\",\"citykey\") VALUES (" + "nextval('evuser_userkey_seq')" + ",?,?,?,?)");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"Warning: City not found for User '\" + CityNotFound.userid + \"'. Please verify the city data.\"");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    \\\"evuser\\\".\\\"userid\\\",    \\\"evuser\\\".\\\"firstname\\\",    \\\"evuser\\\".\\\"lastname\\\",    \\\"evuser\\\".\\\"birthdate\\\",    \\\"evuser\\\".\\\"email\\\",    \\\"evuser\\\".\\\"phone\\\",    \\\"evuser\\\".\\\"street\\\",    \\\"evuser\\\".\\\"postalcode\\\",    \\\"evuser\\\".\\\"city\\\"  FROM \\\"evuser\\\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("userid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("firstname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("lastname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("birthdate")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("email")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("phone")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("street")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("postalcode")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("city")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.cityname = '" + row2HashKey.cityname + "'");
								} // G 071
...
log.debug("tMap_1 - Outputting the record " + count_CityFound_tMap_1 + " of the output table 'CityFound'.");
...
log.debug("tMap_1 - Outputting the record " + count_CityNotFound_tMap_1 + " of the output table 'CityNotFound'.");
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.userid = '" + row3HashKey.userid + "'");
								} // G 071
...
log.debug("tMap_2 - Outputting the record " + count_UserFound_tMap_2 + " of the output table 'UserFound'.");
...
log.debug("tMap_2 - Outputting the record " + count_UserNotFound_tMap_2 + " of the output table 'UserNotFound'.");
...
if(UserFound != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"UserFound","tMap_2","tMap_2","tMap","tDBOutput_1","\"evuser\"","tPostgresqlOutput"
...
} else {pstmt_tDBOutput_1.setInt(1, UserFound.userid);
}

                    if(UserFound.fullname == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, UserFound.fullname);
}

                    if(UserFound.birthdate != null) {
pstmt_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(UserFound.birthdate.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setInt(4, UserFound.citykey);
}
...
if(UserNotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"UserNotFound","tMap_2","tMap_2","tMap","tDBOutput_2","\"evuser\"","tPostgresqlOutput"
...
} else {pstmt_tDBOutput_2.setInt(1, UserNotFound.userid);
}

                    if(UserNotFound.fullname == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, UserNotFound.fullname);
}

                    if(UserNotFound.birthdate != null) {
pstmt_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(UserNotFound.birthdate.getTime()));
} else {
...
} else {pstmt_tDBOutput_2.setInt(4, UserNotFound.citykey);
}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Warning: City not found for User '" + CityNotFound.userid + "'. Please verify the city data.","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("Warning: City not found for User '" + CityNotFound.userid + "'. Please verify the city data.")  + (". Code: ")  + (42) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "Warning: City not found for User '" + CityNotFound.userid + "'. Please verify the city data."); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_2{
                    ...
                    log4jParamters_tWarn_2.append("Parameters:");
                            log4jParamters_tWarn_2.append("MESSAGE" + " = " + "\"EVUser Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "WARN","","EVUser Load is done!","", "");
            log.warn("tWarn_2 - "  + ("Message: ")  + ("EVUser Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_2_WARN_MESSAGES", "EVUser Load is done!"); 
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_1","\"city\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_1","\"city\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		int tos_count_tAdvancedHash_row3 = 0;
			...
			if(enableLogStash) {
				...
				s(currentComponent);
			   		...
			   		// linked node: tMap_2 - inputs:(CityFound,row3) outputs:(UserFound,UserNotFound)
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT    \\\"evuser\\\".\\\"userkey\\\",    \\\"evuser\\\".\\\"userid\\\",    \\\"evuser\\\".\\\"fullname\\\",    \\\"evuser\\\".\\\"birthdate\\\",    \\\"evuser\\\".\\\"citykey\\\"  FROM \\\"evuser\\\"\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("userkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("userid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("fullname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("birthdate")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("citykey")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row3");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_3","\"evuser\"","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash"
...
tHash_Lookup_row3.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_3","\"evuser\"","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'EVUserLoad' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:04.074256Z");
        ...
        try {
            ...
            java.io.InputStream inContext = EVUserLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/evuserload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = EVUserLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     272779 characters generated by Talend Real-time Big Data Platform 
