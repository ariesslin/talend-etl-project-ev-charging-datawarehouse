...
package ie6750_project1_grouph.bookingload_0_1;
...
/**
 * Job: BookingLoad Purpose: <br>
 * Description:  <br>
 * @author lin.shan1@northeastern.edu
 * @version 8.0.1.20240920_1319-patch
 * @status 
 */
public class BookingLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "BookingLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(BookingLoad.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "BookingLoad";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_kWVL4JvcEe-5PpigxqfS-w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BookingLoad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:vkZEyWyxrBXvVPZPjZoZTJB+5BdF1fBfJi9/rEoHXYSlbg==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:LWSfYK7akTodus7hJMnhYPdXPklmmjpxApS8BKY50NM3Dw==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:Q8B4TIqS6NFmhkw6ptUQVonGAKUkfIEQorYLEcVmWAmsng==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6g7tv62uGnIIvc38rLfbK6FagLoDuF6gfy+RaUyvxyFnZg==");
...
public static class FoundStruct implements routines.system.IPersistableRow<FoundStruct> {
    final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_BookingLoad = new byte[0];
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.bookingkey;
	...
	public boolean equals(Object obj) {
		...
		final FoundStruct other = (FoundStruct) obj;
						...
						if (this.bookingkey != other.bookingkey)
							return false;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad.length) {
				if(length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad.length == 0) {
   					commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad = new byte[1024];
				} else {
   					commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_BookingLoad) {
    ...
    public int compareTo(FoundStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.bookingkey, other.bookingkey);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_BookingLoad = new byte[0];
				...
				public Boolean datetimeIsNullable(){
				    return true;
				}
				public Boolean datetimeIsKey(){
				    return false;
				}
				public Integer datetimeLength(){
				    return 29;
				}
				...
				public String datetimeOriginalDbColumnName(){
				...
				public Boolean iscancelledIsNullable(){
				    return true;
				}
				public Boolean iscancelledIsKey(){
				    return false;
				}
				public Integer iscancelledLength(){
				    return 1;
				}
				public Integer iscancelledPrecision(){
				    return 0;
				}
				public String iscancelledDefault(){
				
					return null;
				
				}
				public String iscancelledComment(){
				
				    return "";
				
				}
				public String iscancelledPattern(){
				
					return "";
				
				}
				public String iscancelledOriginalDbColumnName(){
			    ...
			    public Integer cancelledreasonid;

				public Integer getCancelledreasonid () {
					return this.cancelledreasonid;
				}

				public Boolean cancelledreasonidIsNullable(){
				    return true;
				}
				public Boolean cancelledreasonidIsKey(){
				    return false;
				}
				public Integer cancelledreasonidLength(){
				    return 10;
				}
				public Integer cancelledreasonidPrecision(){
				    return 0;
				}
				public String cancelledreasonidDefault(){
				
					return null;
				
				}
				public String cancelledreasonidComment(){
				
				    return "";
				
				}
				public String cancelledreasonidPattern(){
				
					return "";
				
				}
				public String cancelledreasonidOriginalDbColumnName(){
					...
					this.datetime = readDate(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.iscancelled = dis.readBoolean();
           				}
					
						this.cancelledreasonid = readInteger(dis);
					...
					// Boolean
						...
						if(this.iscancelled == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeBoolean(this.iscancelled);
		            	}
					
					// Integer
				
						writeInteger(this.cancelledreasonid,dos);
    ...
    public String toString() {
		...
		sb.append(",iscancelled="+String.valueOf(iscancelled));
		sb.append(",cancelledreasonid="+String.valueOf(cancelledreasonid));
	    sb.append("]");
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(cancelledreasonid == null){
        					sb.append("<null>");
        				}else{
            				sb.append(cancelledreasonid);
            			}
...
public static class after_tDBInput_1Struct implements routines.system.IPersistableRow<after_tDBInput_1Struct> {
	...
	public void copyDataTo(after_tDBInput_1Struct other) {
		...
		other.bookingid = this.bookingid;
	            ...
	            other.cancelledreasonid = this.cancelledreasonid;
...
NotFoundStruct NotFound = new NotFoundStruct();
	...
	s(currentComponent="tDBOutput_1");
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"booking\"");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"booking\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("booking");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("booking");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"bookingid\" = ?,\"chargertype\" = ? WHERE \"bookingkey\" = ?";
 ...
 */
	...
	s(currentComponent="tDBOutput_2");
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"booking\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("bookingkey")+", NAME="+("\"bookingkey\"")+", SQL="+("\"nextval('booking_bookingkey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"booking\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("booking");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("booking");
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "bookingkey" + "\",\"bookingid\",\"chargertype\") VALUES (" + "nextval('booking_bookingkey_seq')" + ",?,?)");
 ...
 */
	...
	s(currentComponent="tDBInput_1");
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"booking\\\".\\\"bookingid\\\",    \\\"booking\\\".\\\"stationid\\\",    \\\"booking\\\".\\\"userid\\\",    \\\"booking\\\".\\\"chargertype\\\",    \\\"booking\\\".\\\"datetime\\\",    \\\"booking\\\".\\\"iscancelled\\\",    \\\"booking\\\".\\\"cancelledreasonid\\\"  FROM \\\"booking\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("bookingid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("stationid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("userid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("chargertype")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("datetime")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("iscancelled")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("cancelledreasonid")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "\"booking\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
+"\"";
            ...
            row1.userid = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.chargertype = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.datetime = null;
							} else {
										
			row1.datetime = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.iscancelled = null;
							} else {
	                         		
            row1.iscancelled = rs_tDBInput_1.getBoolean(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.iscancelled = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.cancelledreasonid = null;
							} else {
		                          
            row1.cancelledreasonid = rs_tDBInput_1.getInt(7);
            if(rs_tDBInput_1.wasNull()){
                    row1.cancelledreasonid = null;
            }
		                    }
 ...
 */
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","\"booking\"","tPostgresqlInput","tMap_1","tMap_1","tMap"
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.bookingid = row1.bookingid ;
...
Found_tmp.bookingkey = row2.bookingkey;
Found_tmp.bookingid = row2.bookingid ;
Found_tmp.chargertype = row1.chargertype ;
Found = Found_tmp;
...
NotFound_tmp.bookingkey = 0;
NotFound_tmp.bookingid = row1.bookingid;
NotFound_tmp.chargertype = row1.chargertype;
...
if(Found != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found","tMap_1","tMap_1","tMap","tDBOutput_1","\"booking\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    if(Found.bookingid == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, Found.bookingid);
}

                    if(Found.chargertype == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, Found.chargertype);
}

                    pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, Found.bookingkey);
...
if(NotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tDBOutput_2","\"booking\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    if(NotFound.bookingid == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, NotFound.bookingid);
}

                    if(NotFound.chargertype == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, NotFound.chargertype);
}
...
// ###############################      
				...
				log.debug("tMap_1 - Written records count in the table 'NotFound': " + count_NotFound_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","\"booking\"","tPostgresqlInput","tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Found",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_1","\"booking\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"NotFound",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_2","\"booking\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"Booking Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Booking Load is done!","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("Booking Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "Booking Load is done!"); 
 ...
 */
	...
	s(currentComponent="tDBInput_2");
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    \\\"booking\\\".\\\"bookingkey\\\",    \\\"booking\\\".\\\"bookingid\\\",    \\\"booking\\\".\\\"chargertype\\\"  FROM \\\"booking\\\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("bookingkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("bookingid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("chargertype")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_2", "\"booking\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
            ...
            row2.bookingkey = rs_tDBInput_2.getInt(1);
        	...
        	row2.chargertype = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"booking\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
				...
				row2_HashRow.bookingkey = row2.bookingkey;
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"booking\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final BookingLoad BookingLoadClass = new BookingLoad();

        int exitCode = BookingLoadClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'BookingLoad' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'BookingLoad' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_kWVL4JvcEe-5PpigxqfS-w");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:05.079404Z");
        ...
        try {
            ...
            java.io.InputStream inContext = BookingLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/bookingload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BookingLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'BookingLoad' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BookingLoad");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'BookingLoad' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     196341 characters generated by Talend Real-time Big Data Platform 
