...
public class BookingLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "BookingLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(BookingLoad.class);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:HQAg3lavnUTAMIRV9ffrMbV92gD7qxCfXxNMUz1o6GooYw==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:atPpWg4BFzy4dp1Cqe2eurVFfBNl4K7YZY7zm9QpqoBeKg==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:qC4tKRHPUEjPT1Xw+GLyjJfcHEyHa9XvyeBEKqjLAMx4qQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:+IFNfZd2Sd+QXdnZ1e2qqM56cTb+xvPNZh38haiLgEuX2w==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"bookingid\" = ?,\"chargertype\" = ? WHERE \"bookingkey\" = ?";
					...
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("bookingkey") + ", NAME=" + ("\"bookingkey\"") + ", SQL="
									+ ("\"nextval('booking_bookingkey_seq')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "bookingkey"
						+ "\",\"bookingid\",\"chargertype\") VALUES (" + "nextval('booking_bookingkey_seq')" + ",?,?)");
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"booking\\\".\\\"bookingid\\\",    \\\"booking\\\".\\\"stationid\\\",    \\\"booking\\\".\\\"userid\\\",    \\\"booking\\\".\\\"chargertype\\\",    \\\"booking\\\".\\\"datetime\\\",    \\\"booking\\\".\\\"iscancelled\\\",    \\\"booking\\\".\\\"cancelledreasonid\\\"  FROM \\\"booking\\\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("bookingid") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("stationid") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("userid")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("chargertype") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("datetime") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("iscancelled") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("cancelledreasonid") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.bookingid = '" +
							// row2HashKey.bookingid + "'");
						} // G 071
...
// Start of branch "Found"
						if (Found != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "Found", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "\"booking\"",
									"tPostgresqlOutput"
							...
							if (Found.bookingid == null) {
								...
								pstmt_tDBOutput_1.setInt(1, Found.bookingid);
							}

							if (Found.chargertype == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, Found.chargertype);
							}
...
// Start of branch "NotFound"
						if (NotFound != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "NotFound", "tMap_1", "tMap_1", "tMap", "tDBOutput_2", "\"booking\"",
									"tPostgresqlOutput"
							...
							if (NotFound.bookingid == null) {
								...
								pstmt_tDBOutput_2.setInt(1, NotFound.bookingid);
							}

							if (NotFound.chargertype == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, NotFound.chargertype);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Found", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "\"booking\"", "tPostgresqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"booking\"", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"booking\"", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-07T03:01:01.737983Z");
		...
		try {
			...
			java.io.InputStream inContext = BookingLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/bookingload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = BookingLoad.class.getClassLoader()
...
/************************************************************************************************
 * 191414 characters generated by Talend Real-time Big Data Platform on the 7
 * November 2024 at 04:01:01 CET
 ************************************************************************************************/