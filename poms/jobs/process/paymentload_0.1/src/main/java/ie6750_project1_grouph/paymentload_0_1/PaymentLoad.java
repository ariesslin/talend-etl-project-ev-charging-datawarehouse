...
package ie6750_project1_grouph.paymentload_0_1;
...
/**
 * Job: PaymentLoad Purpose: <br>
 * Description:  <br>
 * @author lin.shan1@northeastern.edu
 * @version 8.0.1.20240920_1319-patch
 * @status 
 */
public class PaymentLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "PaymentLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(PaymentLoad.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "PaymentLoad";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_l_sWYJvcEe-5PpigxqfS-w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PaymentLoad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:mDdgMHf397v0cQTMWxkPBCtUAQw5Ug1LvK+wVWsZV/MYrQ==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:AuK+PynRdf7jM1A6dXRZ648LEMZI/vVtwJihx0ZPuQbD8Q==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:xuQDY/2y/2yu5RIYJQnDkJiKfyHi9RVlrIM9MXkpwSwW1A==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:nJT5r/a8YqJisephmDCSXFt4uDN6/q/97VBsjKsoWcl+Mg==");
...
public static class FoundStruct implements routines.system.IPersistableRow<FoundStruct> {
    final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_PaymentLoad = new byte[0];
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad.length) {
				if(length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad.length == 0) {
   					commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad = new byte[1024];
				} else {
   					commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_PaymentLoad) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.paymenttype = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.paymenttype,dos);
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_PaymentLoad = new byte[0];
			    ...
			    public java.util.Date paymentdatetime;

				public java.util.Date getPaymentdatetime () {
					return this.paymentdatetime;
				}

				public Boolean paymentdatetimeIsNullable(){
				    return true;
				}
				public Boolean paymentdatetimeIsKey(){
				    return false;
				}
				public Integer paymentdatetimeLength(){
				    return 29;
				}
				public Integer paymentdatetimePrecision(){
				    return 6;
				}
				public String paymentdatetimeDefault(){
				
					return null;
				
				}
				public String paymentdatetimeComment(){
				
				    return "";
				
				}
				public String paymentdatetimePattern(){
				
					return "yyyy-MM-dd HH:mm:ss";
				
				}
				public String paymentdatetimeOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_PaymentLoad) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.paymentid = dis.readInt();
					
					this.paymenttype = readString(dis);
					
						this.paymentamount = (BigDecimal) dis.readObject();
					
					this.paymentdatetime = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.paymentdatetime,dos);
    ...
    public String toString() {
		...
		sb.append(",paymenttype="+paymenttype);
		sb.append(",paymentamount="+String.valueOf(paymentamount));
		sb.append(",paymentdatetime="+String.valueOf(paymentdatetime));
		sb.append(",iscompleted="+String.valueOf(iscompleted));
		sb.append(",sessionid="+String.valueOf(sessionid));
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.paymentid;
...
NotFoundStruct NotFound = new NotFoundStruct();
	...
	s(currentComponent="tDBOutput_1");
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"payment\"");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"payment\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("payment");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("payment");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"paymentid\" = ?,\"paymenttype\" = ?,\"paymentamount\" = ?,\"iscompleted\" = ?,\"sessionid\" = ? WHERE \"paymentkey\" = ?";
 ...
 */
	...
	s(currentComponent="tDBOutput_2");
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"payment\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("paymentkey")+", NAME="+("\"paymentkey\"")+", SQL="+("\"nextval('payment_paymentkey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"payment\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("payment");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("payment");
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "paymentkey" + "\",\"paymentid\",\"paymenttype\",\"paymentamount\",\"iscompleted\",\"sessionid\") VALUES (" + "nextval('payment_paymentkey_seq')" + ",?,?,?,?,?)");
 ...
 */
	...
	s(currentComponent="tDBInput_1");
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"payment\\\".\\\"paymentid\\\",    \\\"payment\\\".\\\"paymenttype\\\",    \\\"payment\\\".\\\"paymentamount\\\",    \\\"payment\\\".\\\"paymentdatetime\\\",    \\\"payment\\\".\\\"iscompleted\\\",    \\\"payment\\\".\\\"sessionid\\\",    \\\"payment\\\".\\\"userid\\\"  FROM \\\"payment\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("paymentid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("paymenttype")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("paymentamount")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("paymentdatetime")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("iscompleted")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("sessionid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("userid")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "\"payment\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
+"ment\"";
            ...
            row1.paymentid = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.paymenttype = null;
							} else {
	                         		
        	row1.paymenttype = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.paymentamount = null;
							} else {
		                          
            row1.paymentamount = rs_tDBInput_1.getBigDecimal(3);
            if(rs_tDBInput_1.wasNull()){
                    row1.paymentamount = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.paymentdatetime = null;
							} else {
										
			row1.paymentdatetime = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 4);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.iscompleted = null;
							} else {
	                         		
            row1.iscompleted = rs_tDBInput_1.getBoolean(5);
            if(rs_tDBInput_1.wasNull()){
                    row1.iscompleted = null;
            }
		                    }
            ...
            row1.sessionid = rs_tDBInput_1.getInt(6);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","\"payment\"","tPostgresqlInput","tMap_1","tMap_1","tMap"
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.paymentid = row1.paymentid ;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.paymentid = '" + row2HashKey.paymentid + "'");
								} // G 071
...
Found_tmp.paymentkey = row2.paymentkey ;
Found_tmp.paymentid = row2.paymentid ;
Found_tmp.paymenttype =  row1.paymenttype ;
Found_tmp.paymentamount = row1.paymentamount ;
Found_tmp.iscompleted = row1.iscompleted ;
Found_tmp.sessionid = row1.sessionid ;
Found = Found_tmp;
log.debug("tMap_1 - Outputting the record " + count_Found_tMap_1 + " of the output table 'Found'.");
...
NotFound_tmp.paymentkey = 0;
NotFound_tmp.paymentid = row1.paymentid;
NotFound_tmp.paymenttype = row1.paymenttype;
NotFound_tmp.paymentamount = row1.paymentamount;
NotFound_tmp.iscompleted = row1.iscompleted;
NotFound_tmp.sessionid = row1.sessionid ;
NotFound = NotFound_tmp;
log.debug("tMap_1 - Outputting the record " + count_NotFound_tMap_1 + " of the output table 'NotFound'.");
...
if(Found != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found","tMap_1","tMap_1","tMap","tDBOutput_1","\"payment\"","tPostgresqlOutput"
...
} else {pstmt_tDBOutput_1.setInt(1, Found.paymentid);
}

                    if(Found.paymenttype == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, Found.paymenttype);
}

                    pstmt_tDBOutput_1.setBigDecimal(3, Found.paymentamount);

                    if(Found.iscompleted == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_1.setBoolean(4, Found.iscompleted);
}

                    if(Found.sessionid == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(5, Found.sessionid);
}

                    pstmt_tDBOutput_1.setInt(6 + count_tDBOutput_1, Found.paymentkey);
...
if(NotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tDBOutput_2","\"payment\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    if(NotFound.paymentid == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, NotFound.paymentid);
}

                    if(NotFound.paymenttype == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, NotFound.paymenttype);
}

                    pstmt_tDBOutput_2.setBigDecimal(3, NotFound.paymentamount);

                    if(NotFound.iscompleted == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_2.setBoolean(4, NotFound.iscompleted);
}

                    if(NotFound.sessionid == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(5, NotFound.sessionid);
}
...
// ###############################      
				...
				log.debug("tMap_1 - Written records count in the table 'NotFound': " + count_NotFound_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","\"payment\"","tPostgresqlInput","tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Found",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_1","\"payment\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"NotFound",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_2","\"payment\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"Payment Load is done!\"");
                        log4jParamters_tWarn_1.append(" | ");
                            log4jParamters_tWarn_1.append("CODE" + " = " + "200");
                        log4jParamters_tWarn_1.append(" | ");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Payment Load is done!","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("Payment Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "Payment Load is done!"); 
 ...
 */
	...
	s(currentComponent="tDBInput_2");
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    \\\"payment\\\".\\\"paymentkey\\\",    \\\"payment\\\".\\\"paymentid\\\",    \\\"payment\\\".\\\"paymenttype\\\",    \\\"payment\\\".\\\"paymentamount\\\",    \\\"payment\\\".\\\"iscompleted\\\",    \\\"payment\\\".\\\"sessionid\\\"  FROM \\\"payment\\\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("paymentkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("paymentid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("paymenttype")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("paymentamount")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("iscompleted")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("sessionid")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_2", "\"payment\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
+"ymentamount\", \n  \"payment\".\"iscompleted\", \n  \"payment\".\"sessionid\"\n FROM \"payment\"";
            ...
            row2.paymentkey = rs_tDBInput_2.getInt(1);
            ...
            row2.paymentid = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    row2.paymentid = null;
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row2.paymenttype = null;
							} else {
	                         		
        	row2.paymenttype = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row2.paymentamount = null;
							} else {
		                          
            row2.paymentamount = rs_tDBInput_2.getBigDecimal(4);
            if(rs_tDBInput_2.wasNull()){
                    row2.paymentamount = null;
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row2.iscompleted = null;
							} else {
	                         		
            row2.iscompleted = rs_tDBInput_2.getBoolean(5);
            if(rs_tDBInput_2.wasNull()){
                    row2.iscompleted = null;
            }
		                    }
            ...
            row2.sessionid = rs_tDBInput_2.getInt(6);
            if(rs_tDBInput_2.wasNull()){
                    row2.sessionid = null;
            }
		                    }
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"payment\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
				...
				row2_HashRow.paymentkey = row2.paymentkey;
				
				row2_HashRow.paymentid = row2.paymentid;
				
				row2_HashRow.paymenttype = row2.paymenttype;
				
				row2_HashRow.paymentamount = row2.paymentamount;
				
				row2_HashRow.iscompleted = row2.iscompleted;
				
				row2_HashRow.sessionid = row2.sessionid;
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"payment\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final PaymentLoad PaymentLoadClass = new PaymentLoad();

        int exitCode = PaymentLoadClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'PaymentLoad' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'PaymentLoad' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_l_sWYJvcEe-5PpigxqfS-w");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:05.152393Z");
        ...
        try {
            ...
            java.io.InputStream inContext = PaymentLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/paymentload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PaymentLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'PaymentLoad' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PaymentLoad");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'PaymentLoad' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     212680 characters generated by Talend Real-time Big Data Platform 
 *     on the 9 November 2024 at 20:56:05 CET
 ************************************************************************************************/