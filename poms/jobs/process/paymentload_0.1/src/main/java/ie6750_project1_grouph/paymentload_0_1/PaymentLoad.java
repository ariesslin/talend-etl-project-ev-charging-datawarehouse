...
public class PaymentLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "PaymentLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(PaymentLoad.class);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:wx8n1jm+7DdCqZQ4GFStnBGITLq9MH7bVWxlm/kdKI7BDA==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:p6mV0Tcg4ML5QFE38RrvxuP7Qe2qGUxN8QypPq5jiUfxFg==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:71KsrHXReUF9gHTSTn3BlRKfcZICsk3teo7dLFJkkJMOVQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:gaqfE8hdDaLGa0aP68ujkQ6yLf8cS8+JtCQCWkbdRObnUw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"paymentid\" = ?,\"paymenttype\" = ?,\"paymentamount\" = ?,\"iscompleted\" = ?,\"sessionid\" = ? WHERE \"paymentkey\" = ?";
					...
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("paymentkey") + ", NAME=" + ("\"paymentkey\"") + ", SQL="
									+ ("\"nextval('payment_paymentkey_seq')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "paymentkey"
						+ "\",\"paymentid\",\"paymenttype\",\"paymentamount\",\"iscompleted\",\"sessionid\") VALUES ("
						+ "nextval('payment_paymentkey_seq')" + ",?,?,?,?,?)");
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"payment\\\".\\\"paymentid\\\",    \\\"payment\\\".\\\"paymenttype\\\",    \\\"payment\\\".\\\"paymentamount\\\",    \\\"payment\\\".\\\"paymentdatetime\\\",    \\\"payment\\\".\\\"iscompleted\\\",    \\\"payment\\\".\\\"sessionid\\\",    \\\"payment\\\".\\\"userid\\\"  FROM \\\"payment\\\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("paymenttype") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("paymentamount")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("paymentdatetime") + "}, {TRIM="
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.paymentid = '" +
							// row2HashKey.paymentid + "'");
						} // G 071
...
// Start of branch "Found"
						if (Found != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "Found", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "\"payment\"",
									"tPostgresqlOutput"
							...
							if (Found.paymentid == null) {
								...
								pstmt_tDBOutput_1.setInt(1, Found.paymentid);
							}

							if (Found.paymenttype == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, Found.paymenttype);
							}
							...
							if (Found.iscompleted == null) {
								...
								pstmt_tDBOutput_1.setBoolean(4, Found.iscompleted);
							}

							if (Found.sessionid == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(5, Found.sessionid);
							}
...
// Start of branch "NotFound"
						if (NotFound != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "NotFound", "tMap_1", "tMap_1", "tMap", "tDBOutput_2", "\"payment\"",
									"tPostgresqlOutput"
							...
							if (NotFound.paymentid == null) {
								...
								pstmt_tDBOutput_2.setInt(1, NotFound.paymentid);
							}

							if (NotFound.paymenttype == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, NotFound.paymenttype);
							}
							...
							if (NotFound.iscompleted == null) {
								...
								pstmt_tDBOutput_2.setBoolean(4, NotFound.iscompleted);
							}

							if (NotFound.sessionid == null) {
								pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(5, NotFound.sessionid);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Found", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "\"payment\"", "tPostgresqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"payment\"", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"payment\"", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T23:00:45.228216Z");
		...
		try {
			...
			java.io.InputStream inContext = PaymentLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/paymentload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = PaymentLoad.class.getClassLoader()
...
/************************************************************************************************
 * 207753 characters generated by Talend Real-time Big Data Platform on the 7
 * November 2024 at 00:00:45 CET
 ************************************************************************************************/