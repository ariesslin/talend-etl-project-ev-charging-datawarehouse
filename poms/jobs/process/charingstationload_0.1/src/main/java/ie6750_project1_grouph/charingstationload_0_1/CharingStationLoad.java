...
package ie6750_project1_grouph.charingstationload_0_1;
...
/**
 * Job: CharingStationLoad Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class CharingStationLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "CharingStationLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(CharingStationLoad.class);
	...
	private final String jobName = "CharingStationLoad";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CharingStationLoad.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CharingStationLoad.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:/U9AshEGs8FgDpwUkEivZcLE+FfXiWLC/IXATiQF9261uw==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:b1X37GWczhTNrNcxRZ6ETei6rLvO2pxAQKT4XRKRLekzug==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:gRPg4gk3WvpssYIhi3wTnJsmbO4xw7FF40VBpe6I8ekxnQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Wf3rnas62rHQM+k1e7kXyMJfJ2eP9JVorAy4JeryOqOWwg==");
	...
	public static class StationFoundStruct implements routines.system.IPersistableRow<StationFoundStruct> {
		final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_CharingStationLoad = new byte[0];
		static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final StationFoundStruct other = (StationFoundStruct) obj;
		...
		public void copyDataTo(StationFoundStruct other) {
		...
		public void copyKeysDataTo(StationFoundStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad.length) {
					if (length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad.length == 0) {
						commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad = new byte[1024];
					} else {
						commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_CharingStationLoad, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IE6750_PROJECT1_GROUPH_CharingStationLoad) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"chargingstation\"");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_2", "\"chargingstation\"", "tPostgresqlOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("chargingstation");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("chargingstation");
				}
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"stationid\" = ?,\"stationname\" = ?,\"citykey\" = ?,\"maxchargingpoints\" = ?,\"stationstatuskey\" = ? WHERE \"stationkey\" = ?";
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"chargingstation\"");
							log4jParamters_tDBOutput_1.append(" | ");
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("stationkey") + ", NAME=" + ("\"stationkey\"") + ", SQL="
									+ ("\"nextval('chargingstation_stationkey_seq')\"") + "}]");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "\"chargingstation\"", "tPostgresqlOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("chargingstation");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("chargingstation");
				}
				...
				sb_tDBOutput_1.append("INSERT INTO \"").append(tableName_tDBOutput_1).append("\" (\"" + "stationkey"
						+ "\",\"stationid\",\"stationname\",\"citykey\",\"maxchargingpoints\",\"stationstatuskey\") VALUES ("
						+ "nextval('chargingstation_stationkey_seq')" + ",?,?,?,?,?)");
...
// # Outputs initialization
				int count_StationFound_tMap_3 = 0;

				StationFoundStruct StationFound_tmp = new StationFoundStruct();
				int count_StationNotFound_tMap_3 = 0;
...
// Start of branch "StatusFound"
							if (StatusFound != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									row4HashKey.stationid = StatusFound.stationid;
								...
								if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									// and it contains more one result from keys : row4.stationid = '" +
									// row4HashKey.stationid + "'");
								} // G 071
...
// # Output table : 'StationFound'
										count_StationFound_tMap_3++;

										StationFound_tmp.stationkey = row4.stationkey;
										StationFound_tmp.stationid = row4.stationid;
										StationFound_tmp.stationname = StatusFound.stationname;
										StationFound_tmp.citykey = StatusFound.citykey;
										StationFound_tmp.maxchargingpoints = StatusFound.maxchargingpoints;
										StationFound_tmp.stationstatuskey = StatusFound.stationstatuskey;
										StationFound = StationFound_tmp;
										log.debug("tMap_3 - Outputting the record " + count_StationFound_tMap_3
...
// # Filter conditions 
									if (rejectedInnerJoin_tMap_3) {
										count_StationNotFound_tMap_3++;

										StationNotFound_tmp.stationkey = 0;
										StationNotFound_tmp.stationid = StatusFound.stationid;
										StationNotFound_tmp.stationname = StatusFound.stationname;
										StationNotFound_tmp.citykey = StatusFound.citykey;
										StationNotFound_tmp.maxchargingpoints = StatusFound.maxchargingpoints;
										StationNotFound_tmp.stationstatuskey = StatusFound.stationstatuskey;
										StationNotFound = StationNotFound_tmp;
										log.debug("tMap_3 - Outputting the record " + count_StationNotFound_tMap_3
...
// Start of branch "StationFound"
								if (StationFound != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "StationFound", "tMap_3", "tMap_3", "tMap", "tDBOutput_2",
											"\"chargingstation\"", "tPostgresqlOutput"
									...
									if (log.isTraceEnabled()) {
										log.trace("StationFound - "
												+ (StationFound == null ? "" : StationFound.toLogString()));
									}

									whetherReject_tDBOutput_2 = false;
									if (StationFound.stationid == null) {
										pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(1, StationFound.stationid);
									}

									if (StationFound.stationname == null) {
										pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(2, StationFound.stationname);
									}

									if (StationFound.citykey == null) {
										pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(3, StationFound.citykey);
									}

									if (StationFound.maxchargingpoints == null) {
										pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(4, StationFound.maxchargingpoints);
									}

									if (StationFound.stationstatuskey == null) {
										pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(5, StationFound.stationstatuskey);
									}

									pstmt_tDBOutput_2.setInt(6 + count_tDBOutput_2, StationFound.stationkey);
									...
									if ((batchSize_tDBOutput_2 > 0)
										...
										try {
											...
											if (log.isDebugEnabled())
												log.debug("tDBOutput_2 - " + ("Executing the ") + ("UPDATE")
														+ (" batch."));
...
// Start of branch "StationNotFound"
								if (StationNotFound != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "StationNotFound", "tMap_3", "tMap_3", "tMap", "tDBOutput_1",
											"\"chargingstation\"", "tPostgresqlOutput"
									...
									if (StationNotFound.stationid == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(1, StationNotFound.stationid);
									}

									if (StationNotFound.stationname == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, StationNotFound.stationname);
									}

									if (StationNotFound.citykey == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(3, StationNotFound.citykey);
									}

									if (StationNotFound.maxchargingpoints == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(4, StationNotFound.maxchargingpoints);
									}

									if (StationNotFound.stationstatuskey == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(5, StationNotFound.stationstatuskey);
									}
...
// ###############################      
				log.debug("tMap_3 - Written records count in the table 'StationFound': " + count_StationFound_tMap_3
						+ ".");
				log.debug("tMap_3 - Written records count in the table 'StationNotFound': "
						+ count_StationNotFound_tMap_3 + ".");
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "StationFound", 2, 0,
						"tMap_3", "tMap_3", "tMap", "tDBOutput_2", "\"chargingstation\"", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "StationNotFound", 2, 0,
						"tMap_3", "tMap_3", "tMap", "tDBOutput_1", "\"chargingstation\"", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(StatusFound,row4)
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_4", "\"chargingstation\"", "tPostgresqlInput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							...
							row4.stationkey = rs_tDBInput_4.getInt(1);
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							...
							row4.stationid = rs_tDBInput_4.getInt(2);
							if (rs_tDBInput_4.wasNull()) {
								row4.stationid = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 3) {
							row4.stationname = null;
						} else {

							row4.stationname = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
						}
						if (colQtyInRs_tDBInput_4 < 4) {
							row4.citykey = null;
						} else {

							row4.citykey = rs_tDBInput_4.getInt(4);
							if (rs_tDBInput_4.wasNull()) {
								row4.citykey = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 5) {
							row4.maxchargingpoints = null;
						} else {

							row4.maxchargingpoints = rs_tDBInput_4.getInt(5);
							if (rs_tDBInput_4.wasNull()) {
								row4.maxchargingpoints = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 6) {
							row4.stationstatuskey = null;
						} else {

							row4.stationstatuskey = rs_tDBInput_4.getInt(6);
							if (rs_tDBInput_4.wasNull()) {
								row4.stationstatuskey = null;
							}
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row4", "tDBInput_4", "\"chargingstation\"", "tPostgresqlInput", "tAdvancedHash_row4",
						...
						row4_HashRow.stationid = row4.stationid;

						row4_HashRow.stationname = row4.stationname;

						row4_HashRow.citykey = row4.citykey;

						row4_HashRow.maxchargingpoints = row4.maxchargingpoints;

						row4_HashRow.stationstatuskey = row4.stationstatuskey;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tDBInput_4", "\"chargingstation\"", "tPostgresqlInput", "tAdvancedHash_row4",
	...
	public static void main(String[] args) {
		final CharingStationLoad CharingStationLoadClass = new CharingStationLoad();

		int exitCode = CharingStationLoadClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'CharingStationLoad' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'CharingStationLoad' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_cdgOcJvcEe-5PpigxqfS-w");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T22:57:50.647073Z");
		...
		try {
			...
			java.io.InputStream inContext = CharingStationLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/charingstationload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CharingStationLoad.class.getClassLoader()
		...
		log.info("TalendJob: 'CharingStationLoad' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : CharingStationLoad");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'CharingStationLoad' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 334936 characters generated by Talend Real-time Big Data Platform on the 6
 * November 2024 at 23:57:50 CET
 ************************************************************************************************/