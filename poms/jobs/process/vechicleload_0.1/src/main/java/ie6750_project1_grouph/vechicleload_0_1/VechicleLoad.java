...
package ie6750_project1_grouph.vechicleload_0_1;
...
/**
 * Job: VechicleLoad Purpose: <br>
 * Description:  <br>
 * @author lin.shan1@northeastern.edu
 * @version 8.0.1.20240920_1319-patch
 * @status 
 */
public class VechicleLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "VechicleLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(VechicleLoad.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "VechicleLoad";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_aby1YJvcEe-5PpigxqfS-w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(VechicleLoad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:iXlXvOuTBJxvZrxT3Q727Wzld64tamlym4Os/gMHM+FtLQ==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:moHxzhqrKxDWjv6Gl8PTNS+1n2jzngZaTGWh2LEwE/xF7Q==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:jhgvG2VAMBp7+0eIc8V4vtowFxKozFzPwR3/PDa7AhRWEg==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:/nNpNg/z5SI7vVizrSHRkG9Hi4BtihOc5mloCz3P1p6ilQ==");
...
public static class VehicleFoundStruct implements routines.system.IPersistableRow<VehicleFoundStruct> {
    final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_VechicleLoad = new byte[0];
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final VehicleFoundStruct other = (VehicleFoundStruct) obj;
	...
	public void copyDataTo(VehicleFoundStruct other) {
	...
	public void copyKeysDataTo(VehicleFoundStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad.length) {
				if(length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad.length == 0) {
   					commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad = new byte[1024];
				} else {
   					commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_VechicleLoad) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.chargertype = readString(dis);
						...
						this.batterycapacity = (BigDecimal) dis.readObject();
					
						this.range = (BigDecimal) dis.readObject();
					
						this.userkey = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.batterycapacity);
					
					// BigDecimal
				
       			    	dos.writeObject(this.range);
					
					// Integer
				
						writeInteger(this.userkey,dos);
...
public static class VehicleNotFoundStruct implements routines.system.IPersistableRow<VehicleNotFoundStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final VehicleNotFoundStruct other = (VehicleNotFoundStruct) obj;
	...
	public void copyDataTo(VehicleNotFoundStruct other) {
	...
	public void copyKeysDataTo(VehicleNotFoundStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_VechicleLoad = new byte[0];
				...
				public Boolean platenumberIsNullable(){
				    return true;
				}
				public Boolean platenumberIsKey(){
				    return false;
				}
				public Integer platenumberLength(){
				    return 20;
				}
				public Integer platenumberPrecision(){
				    return 0;
				}
				public String platenumberDefault(){
				
					return null;
				
				}
				public String platenumberComment(){
				
				    return "";
				
				}
				public String platenumberPattern(){
				
					return "";
				
				}
				public String platenumberOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_VechicleLoad) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.platenumber = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.platenumber,dos);
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.vehicleid;
...
UserNotFoundStruct UserNotFound = new UserNotFoundStruct();
	...
	s(currentComponent="tDBOutput_1");
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"vehicle\"");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"vehicle\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("vehicle");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("vehicle");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"vehicleid\" = ?,\"make\" = ?,\"chargertype\" = ?,\"batterycapacity\" = ?,\"range\" = ?,\"userkey\" = ? WHERE \"vehiclekey\" = ?";
 ...
 */
	...
	s(currentComponent="tDBOutput_2");
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"vehicle\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("vehiclekey")+", NAME="+("\"vehiclekey\"")+", SQL="+("\"nextval('vehicle_vehiclekey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"vehicle\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("vehicle");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("vehicle");
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "vehiclekey" + "\",\"vehicleid\",\"make\",\"chargertype\",\"batterycapacity\",\"range\",\"userkey\") VALUES (" + "nextval('vehicle_vehiclekey_seq')" + ",?,?,?,?,?,?)");
...
// # Outputs initialization
				int count_VehicleFound_tMap_2 = 0;
				
VehicleFoundStruct VehicleFound_tmp = new VehicleFoundStruct();
				int count_VehicleNotFound_tMap_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"Warning: User not found for Vehicle '\" + UserNotFound.vehicleid + \"'. Please verify the user data.\"");
...
// ###############################
// # Outputs initialization
				int count_UserFound_tMap_1 = 0;
				
UserFoundStruct UserFound_tmp = new UserFoundStruct();
				int count_UserNotFound_tMap_1 = 0;
 ...
 */
	...
	s(currentComponent="tDBInput_1");
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"vehicle\\\".\\\"vehicleid\\\",    \\\"vehicle\\\".\\\"make\\\",    \\\"vehicle\\\".\\\"chargertype\\\",    \\\"vehicle\\\".\\\"batterycapacity\\\",    \\\"vehicle\\\".\\\"range\\\",    \\\"vehicle\\\".\\\"platenumber\\\",    \\\"vehicle\\\".\\\"userid\\\"  FROM \\\"vehicle\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("vehicleid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("make")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("chargertype")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("batterycapacity")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("range")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("platenumber")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("userid")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "\"vehicle\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
+"apacity\", \n  \"vehicle\".\"range\", \n  \"vehicle\".\"platenumber\", \n  \"vehicle\".\"userid\"\n FROM \"vehicle\"";
            ...
            row1.vehicleid = rs_tDBInput_1.getInt(1);
        	...
        	row1.make = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.chargertype = null;
							} else {
	                         		
        	row1.chargertype = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.batterycapacity = null;
							} else {
		                          
            row1.batterycapacity = rs_tDBInput_1.getBigDecimal(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.batterycapacity = null;
            }
		                    }
            ...
            row1.range = rs_tDBInput_1.getBigDecimal(5);
            if(rs_tDBInput_1.wasNull()){
                    row1.range = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.platenumber = null;
							} else {
	                         		
        	row1.platenumber = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.userid = 0;
							} else {
		                          
            row1.userid = rs_tDBInput_1.getInt(7);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","\"vehicle\"","tPostgresqlInput","tMap_1","tMap_1","tMap"
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.userid = '" + row2HashKey.userid + "'");
								} // G 071
...
count_UserFound_tMap_1++;

UserFound_tmp.vehiclekey = 0;
UserFound_tmp.vehicleid = row1.vehicleid ;
UserFound_tmp.make = row1.make;
UserFound_tmp.chargertype = row1.chargertype ;
UserFound_tmp.batterycapacity = row1.batterycapacity ;
UserFound_tmp.range = row1.range ;
UserFound_tmp.userkey = row2.userkey ;
UserFound = UserFound_tmp;
log.debug("tMap_1 - Outputting the record " + count_UserFound_tMap_1 + " of the output table 'UserFound'.");
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
count_UserNotFound_tMap_1++;

UserNotFound_tmp.vehiclekey = 0;
UserNotFound_tmp.vehicleid = row1.vehicleid;
UserNotFound_tmp.make = row1.make;
UserNotFound_tmp.chargertype = row1.chargertype;
UserNotFound_tmp.batterycapacity = row1.batterycapacity;
UserNotFound_tmp.range = row1.range;
UserNotFound_tmp.userkey = row2.userkey ;
UserNotFound = UserNotFound_tmp;
log.debug("tMap_1 - Outputting the record " + count_UserNotFound_tMap_1 + " of the output table 'UserNotFound'.");
...
if(UserFound != null) { 
	...
	s(currentComponent="tMap_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"UserFound","tMap_1","tMap_1","tMap","tMap_2","tMap_2","tMap"
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row3HashKey.vehicleid = UserFound.vehicleid ;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.vehicleid = '" + row3HashKey.vehicleid + "'");
								} // G 071
...
count_VehicleFound_tMap_2++;

VehicleFound_tmp.vehiclekey = row3.vehiclekey ;
VehicleFound_tmp.vehicleid = row3.vehicleid ;
VehicleFound_tmp.make = UserFound.make ;
VehicleFound_tmp.chargertype = UserFound.chargertype ;
VehicleFound_tmp.batterycapacity = UserFound.batterycapacity ;
VehicleFound_tmp.range = UserFound.range ;
VehicleFound_tmp.userkey = UserFound.userkey ;
VehicleFound = VehicleFound_tmp;
log.debug("tMap_2 - Outputting the record " + count_VehicleFound_tMap_2 + " of the output table 'VehicleFound'.");
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
count_VehicleNotFound_tMap_2++;

VehicleNotFound_tmp.vehiclekey = 0;
VehicleNotFound_tmp.vehicleid = UserFound.vehicleid;
VehicleNotFound_tmp.make = UserFound.make;
VehicleNotFound_tmp.chargertype = UserFound.chargertype;
VehicleNotFound_tmp.batterycapacity = UserFound.batterycapacity;
VehicleNotFound_tmp.range = UserFound.range;
VehicleNotFound_tmp.userkey = UserFound.userkey;
VehicleNotFound = VehicleNotFound_tmp;
log.debug("tMap_2 - Outputting the record " + count_VehicleNotFound_tMap_2 + " of the output table 'VehicleNotFound'.");
...
if(VehicleFound != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"VehicleFound","tMap_2","tMap_2","tMap","tDBOutput_1","\"vehicle\"","tPostgresqlOutput"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("VehicleFound - " + (VehicleFound==null? "": VehicleFound.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(VehicleFound.vehicleid == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, VehicleFound.vehicleid);
}

                    if(VehicleFound.make == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, VehicleFound.make);
}

                    if(VehicleFound.chargertype == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, VehicleFound.chargertype);
}

                    pstmt_tDBOutput_1.setBigDecimal(4, VehicleFound.batterycapacity);

                    pstmt_tDBOutput_1.setBigDecimal(5, VehicleFound.range);

                    if(VehicleFound.userkey == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(6, VehicleFound.userkey);
}

                    pstmt_tDBOutput_1.setInt(7 + count_tDBOutput_1, VehicleFound.vehiclekey);
...
if(VehicleNotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"VehicleNotFound","tMap_2","tMap_2","tMap","tDBOutput_2","\"vehicle\"","tPostgresqlOutput"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("VehicleNotFound - " + (VehicleNotFound==null? "": VehicleNotFound.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_2 = false;
                    if(VehicleNotFound.vehicleid == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, VehicleNotFound.vehicleid);
}

                    if(VehicleNotFound.make == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, VehicleNotFound.make);
}

                    if(VehicleNotFound.chargertype == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, VehicleNotFound.chargertype);
}

                    pstmt_tDBOutput_2.setBigDecimal(4, VehicleNotFound.batterycapacity);

                    pstmt_tDBOutput_2.setBigDecimal(5, VehicleNotFound.range);

                    if(VehicleNotFound.userkey == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(6, VehicleNotFound.userkey);
}
...
if(UserNotFound != null) { 
	...
	s(currentComponent="tWarn_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"UserNotFound","tMap_1","tMap_1","tMap","tWarn_1","tWarn_1","tWarn"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("UserNotFound - " + (UserNotFound==null? "": UserNotFound.toLogString()));
    			}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Warning: User not found for Vehicle '" + UserNotFound.vehicleid + "'. Please verify the user data.","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("Warning: User not found for Vehicle '" + UserNotFound.vehicleid + "'. Please verify the user data.")  + (". Code: ")  + (42) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "Warning: User not found for Vehicle '" + UserNotFound.vehicleid + "'. Please verify the user data."); 
...
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'UserFound': " + count_UserFound_tMap_1 + ".");
				log.debug("tMap_1 - Written records count in the table 'UserNotFound': " + count_UserNotFound_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","\"vehicle\"","tPostgresqlInput","tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'VehicleFound': " + count_VehicleFound_tMap_2 + ".");
				log.debug("tMap_2 - Written records count in the table 'VehicleNotFound': " + count_VehicleNotFound_tMap_2 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"VehicleFound",2,0,
			 			"tMap_2","tMap_2","tMap","tDBOutput_1","\"vehicle\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"VehicleNotFound",2,0,
			 			"tMap_2","tMap_2","tMap","tDBOutput_2","\"vehicle\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_2{
                    ...
                    log4jParamters_tWarn_2.append("Parameters:");
                            log4jParamters_tWarn_2.append("MESSAGE" + " = " + "\"Vehicle Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "WARN","","Vehicle Load is done!","", "");
            log.warn("tWarn_2 - "  + ("Message: ")  + ("Vehicle Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_2_WARN_MESSAGES", "Vehicle Load is done!"); 
		...
		int tos_count_tAdvancedHash_row2 = 0;
			...
			if(enableLogStash) {
				...
				s(currentComponent);
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(UserFound,UserNotFound)
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    \\\"evuser\\\".\\\"userkey\\\",    \\\"evuser\\\".\\\"userid\\\",    \\\"evuser\\\".\\\"fullname\\\",    \\\"evuser\\\".\\\"birthdate\\\",    \\\"evuser\\\".\\\"citykey\\\"  FROM \\\"evuser\\\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("userkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("userid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("fullname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("birthdate")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("citykey")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
...
+" \"evuser\".\"citykey\"\n FROM \"evuser\"";
            ...
            row2.userkey = rs_tDBInput_2.getInt(1);
            ...
            row2.userid = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    row2.userid = null;
            }
		                    }
        	...
        	row2.fullname = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row2.birthdate = null;
							} else {
										
			row2.birthdate = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 4);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row2.citykey = null;
							} else {
		                          
            row2.citykey = rs_tDBInput_2.getInt(5);
            if(rs_tDBInput_2.wasNull()){
                    row2.citykey = null;
            }
		                    }
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"evuser\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
				...
				row2_HashRow.fullname = row2.fullname;
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"evuser\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		int tos_count_tAdvancedHash_row3 = 0;
			...
			if(enableLogStash) {
				...
				s(currentComponent);
			   		...
			   		// linked node: tMap_2 - inputs:(UserFound,row3) outputs:(VehicleFound,VehicleNotFound)
 ...
 */
	...
	s(currentComponent="tDBInput_3");
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT    \\\"vehicle\\\".\\\"vehiclekey\\\",    \\\"vehicle\\\".\\\"vehicleid\\\",    \\\"vehicle\\\".\\\"make\\\",    \\\"vehicle\\\".\\\"chargertype\\\",    \\\"vehicle\\\".\\\"batterycapacity\\\",    \\\"vehicle\\\".\\\"range\\\",    \\\"vehicle\\\".\\\"userkey\\\"  FROM \\\"vehicle\\\"\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("vehiclekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("vehicleid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("make")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("chargertype")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("batterycapacity")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("range")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("userkey")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_3", "\"vehicle\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
+"pe\", \n  \"vehicle\".\"batterycapacity\", \n  \"vehicle\".\"range\", \n  \"vehicle\".\"userkey\"\n FROM \"vehicle\"";
            ...
            row3.vehiclekey = rs_tDBInput_3.getInt(1);
            ...
            row3.vehicleid = rs_tDBInput_3.getInt(2);
            if(rs_tDBInput_3.wasNull()){
                    row3.vehicleid = null;
            }
		                    }
        	...
        	row3.make = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
							...
							if(colQtyInRs_tDBInput_3 < 4) {
								row3.chargertype = null;
							} else {
	                         		
        	row3.chargertype = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row3.batterycapacity = null;
							} else {
		                          
            row3.batterycapacity = rs_tDBInput_3.getBigDecimal(5);
            if(rs_tDBInput_3.wasNull()){
                    row3.batterycapacity = null;
            }
		                    }
            ...
            row3.range = rs_tDBInput_3.getBigDecimal(6);
            if(rs_tDBInput_3.wasNull()){
                    row3.range = null;
            }
		                    }
            ...
            row3.userkey = rs_tDBInput_3.getInt(7);
            if(rs_tDBInput_3.wasNull()){
                    row3.userkey = null;
            }
		                    }
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row3");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_3","\"vehicle\"","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash"
				...
				row3_HashRow.vehiclekey = row3.vehiclekey;
				
				row3_HashRow.vehicleid = row3.vehicleid;
				
				row3_HashRow.make = row3.make;
				
				row3_HashRow.chargertype = row3.chargertype;
				
				row3_HashRow.batterycapacity = row3.batterycapacity;
				
				row3_HashRow.range = row3.range;
...
tHash_Lookup_row3.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_3","\"vehicle\"","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final VechicleLoad VechicleLoadClass = new VechicleLoad();

        int exitCode = VechicleLoadClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'VechicleLoad' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'VechicleLoad' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_aby1YJvcEe-5PpigxqfS-w");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:04.342437Z");
        ...
        try {
            ...
            java.io.InputStream inContext = VechicleLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/vechicleload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = VechicleLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'VechicleLoad' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : VechicleLoad");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'VechicleLoad' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     282030 characters generated by Talend Real-time Big Data Platform 
 *     on the 9 November 2024 at 20:56:04 CET
 ************************************************************************************************/