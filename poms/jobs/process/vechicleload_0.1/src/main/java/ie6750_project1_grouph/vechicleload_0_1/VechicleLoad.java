...
public class VechicleLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "VechicleLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(VechicleLoad.class);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:xnsyhmPYkVDBYYXCJjozLDlmhwN6N1WMhZhDlmm0SrvI4A==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:kF//lIndGJgiso9qQ2jkIdUjaTtq5J+4v+81x12ClS6uBw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:uf5tln397/Szum8Vxb5MpyiAPiJpVXvSmhnDmKglkr1dgg==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:EWOsQDqSQvGFs21RszBZCJf4GKdtnNd6AFGOqTrS0C0avg==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"vehicleid\" = ?,\"make\" = ?,\"chargertype\" = ?,\"batterycapacity\" = ?,\"range\" = ?,\"userkey\" = ? WHERE \"vehiclekey\" = ?";
					...
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("vehiclekey") + ", NAME=" + ("\"vehiclekey\"") + ", SQL="
									+ ("\"nextval('vehicle_vehiclekey_seq')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "vehiclekey"
						+ "\",\"vehicleid\",\"make\",\"chargertype\",\"batterycapacity\",\"range\",\"userkey\") VALUES ("
						+ "nextval('vehicle_vehiclekey_seq')" + ",?,?,?,?,?,?)");
					...
					class BytesLimit65535_tWarn_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tWarn_1.append("MESSAGE" + " = "
									+ "\"Warning: User not found for Vehicle '\" + UserNotFound.vehicleid + \"'. Please verify the user data.\"");
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"vehicle\\\".\\\"vehicleid\\\",    \\\"vehicle\\\".\\\"make\\\",    \\\"vehicle\\\".\\\"chargertype\\\",    \\\"vehicle\\\".\\\"batterycapacity\\\",    \\\"vehicle\\\".\\\"range\\\",    \\\"vehicle\\\".\\\"platenumber\\\",    \\\"vehicle\\\".\\\"userid\\\"  FROM \\\"vehicle\\\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("make") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("chargertype")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("batterycapacity") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("range") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("platenumber") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("userid") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
...
// # Output table : 'UserFound'
								...
								log.debug("tMap_1 - Outputting the record " + count_UserFound_tMap_1
...
// # Filter conditions 
							if (rejectedInnerJoin_tMap_1) {
								...
								log.debug("tMap_1 - Outputting the record " + count_UserNotFound_tMap_1
...
// Start of branch "UserFound"
						if (UserFound != null) {
							...
							if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row3.vehicleid = '" +
								// row3HashKey.vehicleid + "'");
							} // G 071
...
// # Output table : 'VehicleFound'
									...
									log.debug("tMap_2 - Outputting the record " + count_VehicleFound_tMap_2
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_2) {
									...
									log.debug("tMap_2 - Outputting the record " + count_VehicleNotFound_tMap_2
...
// Start of branch "VehicleFound"
							if (VehicleFound != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "VehicleFound", "tMap_2", "tMap_2", "tMap", "tDBOutput_1", "\"vehicle\"",
										"tPostgresqlOutput"
								...
								if (VehicleFound.vehicleid == null) {
									...
									pstmt_tDBOutput_1.setInt(1, VehicleFound.vehicleid);
								}

								if (VehicleFound.make == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, VehicleFound.make);
								}

								if (VehicleFound.chargertype == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, VehicleFound.chargertype);
								}
								...
								if (VehicleFound.userkey == null) {
									...
									pstmt_tDBOutput_1.setInt(6, VehicleFound.userkey);
								}
...
// Start of branch "VehicleNotFound"
							if (VehicleNotFound != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "VehicleNotFound", "tMap_2", "tMap_2", "tMap", "tDBOutput_2", "\"vehicle\"",
										"tPostgresqlOutput"
								...
								if (VehicleNotFound.vehicleid == null) {
									...
									pstmt_tDBOutput_2.setInt(1, VehicleNotFound.vehicleid);
								}

								if (VehicleNotFound.make == null) {
									pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(2, VehicleNotFound.make);
								}

								if (VehicleNotFound.chargertype == null) {
									pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(3, VehicleNotFound.chargertype);
								}
								...
								if (VehicleNotFound.userkey == null) {
									...
									pstmt_tDBOutput_2.setInt(6, VehicleNotFound.userkey);
								}
							...
							try {
								...
								resumeUtil
										.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "",
												"WARN", "", "Warning: User not found for Vehicle '"
														+ UserNotFound.vehicleid + "'. Please verify the user data.",
												"", "");
								log.warn("tWarn_1 - "
										+ ("Message: ") + ("Warning: User not found for Vehicle '"
												+ UserNotFound.vehicleid + "'. Please verify the user data.")
										+ (". Code: ") + (42));
								globalMap.put("tWarn_1_WARN_MESSAGES", "Warning: User not found for Vehicle '"
										+ UserNotFound.vehicleid + "'. Please verify the user data.");
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'VehicleFound': " + count_VehicleFound_tMap_2
						+ ".");
				log.debug("tMap_2 - Written records count in the table 'VehicleNotFound': "
						+ count_VehicleNotFound_tMap_2 + ".");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"evuser\"", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"evuser\"", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_2 - inputs:(UserFound,row3)
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row3", "tDBInput_3", "\"vehicle\"", "tPostgresqlInput", "tAdvancedHash_row3",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tDBInput_3", "\"vehicle\"", "tPostgresqlInput", "tAdvancedHash_row3", "tAdvancedHash_row3",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T23:08:15.781120Z");
		...
		try {
			...
			java.io.InputStream inContext = VechicleLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/vechicleload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = VechicleLoad.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : VechicleLoad");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 277103 characters generated by Talend Real-time Big Data Platform on the 7
 * November 2024 at 00:08:15 CET
 ************************************************************************************************/