...
package ie6750_project1_grouph.chargingpointload_0_1;
...
/**
 * Job: ChargingPointLoad Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class ChargingPointLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "ChargingPointLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(ChargingPointLoad.class);
	...
	private final String jobName = "ChargingPointLoad";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ChargingPointLoad.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ChargingPointLoad.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:xCV0RyqEPqMForGG4d+Bt8u/nfGMTM93ZwaUngGpsZwN4Q==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:PFWOXipWSmjKt0PF09wjL8zvTntozS/nk7ZjKPzcmgmqew==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:NxNDeMyfn6S4q3EZHgpQuMEYFsMa7WYqNQ63zD+Dwjwf4Q==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XYIwju/3/JryCvwbxo8TfXlzvyTp+satxU4bkfuIH7K7fA==");
	...
	public static class CPFoundStruct implements routines.system.IPersistableRow<CPFoundStruct> {
		final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_ChargingPointLoad = new byte[0];
		static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final CPFoundStruct other = (CPFoundStruct) obj;
		...
		public void copyDataTo(CPFoundStruct other) {
		...
		public void copyKeysDataTo(CPFoundStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad.length) {
					if (length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad.length == 0) {
						commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad = new byte[1024];
					} else {
						commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad, 0, length);
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_ChargingPointLoad, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IE6750_PROJECT1_GROUPH_ChargingPointLoad) {
	...
	public static class CPNotFoundStruct implements routines.system.IPersistableRow<CPNotFoundStruct> {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final CPNotFoundStruct other = (CPNotFoundStruct) obj;
		...
		public void copyDataTo(CPNotFoundStruct other) {
		...
		public void copyKeysDataTo(CPNotFoundStruct other) {
	...
	public static class StationNotFoundStruct implements routines.system.IPersistableRow<StationNotFoundStruct> {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final StationNotFoundStruct other = (StationNotFoundStruct) obj;
		...
		public void copyDataTo(StationNotFoundStruct other) {
		...
		public void copyKeysDataTo(StationNotFoundStruct other) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"chargingpoint\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "\"chargingpoint\"", "tPostgresqlOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("chargingpoint");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("chargingpoint");
				}
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"chargepointid\" = ?,\"chargingcapacity\" = ?,\"chargertype\" = ?,\"installationcost\" = ?,\"chargingpointstatuskey\" = ?,\"stationkey\" = ? WHERE \"chargepointkey\" = ?";
					...
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:hz355gxIPFi4H77ekxW6LtH1Zna6ItownYBWwIOYXxhrsw==")
									.substring(0, 4) + "...");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"chargingpoint\"");
							log4jParamters_tDBOutput_2.append(" | ");
							...
							log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("chargepointkey") + ", NAME=" + ("\"chargepointkey\"") + ", SQL="
									+ ("\"nextval('chargingpoint_chargepointkey_seq')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_2", "\"chargingpoint\"", "tPostgresqlOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("chargingpoint");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("chargingpoint");
				}
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LXzJbZfJp1hxEChQf+6tEXJGUG43VFFwOjifH3lwWp/zSw==");
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "chargepointkey"
						+ "\",\"chargepointid\",\"chargingcapacity\",\"chargertype\",\"installationcost\",\"chargingpointstatuskey\",\"stationkey\") VALUES ("
						+ "nextval('chargingpoint_chargepointkey_seq')" + ",?,?,?,?,?,?)");
...
// # Lookup's keys initialization
				int count_StatusFound_tMap_3 = 0;
...
// # Outputs initialization
				int count_CPFound_tMap_3 = 0;

				CPFoundStruct CPFound_tmp = new CPFoundStruct();
				int count_CPNotFound_tMap_3 = 0;
...
// # Output table : 'StationFound'
								...
								StationFound_tmp.chargepointkey = 0;
								...
								StationFound_tmp.chargingpointstatuskey = null;
...
// # Filter conditions 
							if (rejectedInnerJoin_tMap_1) {
								...
								StationNotFound_tmp.chargepointkey = 0;
								...
								StationNotFound_tmp.chargingpointstatuskey = null;
...
// # Output table : 'StatusFound'
									...
									StatusFound_tmp.chargepointkey = 0;
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_2) {
									...
									StatusNotFound_tmp.chargepointkey = 0;
									...
									StatusNotFound_tmp.chargingpointstatuskey = null;
...
// Start of branch "StatusFound"
							if (StatusFound != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "StatusFound", "tMap_2", "tMap_2", "tMap", "tMap_3", "tMap_3", "tMap"
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									row4HashKey.chargepointid = StatusFound.chargepointid;

									row4HashKey.stationkey = StatusFound.stationkey;
								...
								if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									// and it contains more one result from keys : row4.chargepointid = '" +
									// row4HashKey.chargepointid + "', row4.stationkey = '" + row4HashKey.stationkey
									// + "'");
								} // G 071
...
// # Output table : 'CPFound'
										count_CPFound_tMap_3++;

										CPFound_tmp.chargepointkey = row4.chargepointkey;
										CPFound_tmp.chargepointid = row4.chargepointid;
										CPFound_tmp.chargingcapacity = StatusFound.chargingcapacity;
										CPFound_tmp.chargertype = StatusFound.chargertype;
										CPFound_tmp.installationcost = StatusFound.installationcost;
										CPFound_tmp.chargingpointstatuskey = StatusFound.chargingpointstatuskey;
										CPFound_tmp.stationkey = row4.stationkey;
										CPFound = CPFound_tmp;
										log.debug("tMap_3 - Outputting the record " + count_CPFound_tMap_3
...
// # Filter conditions 
									if (rejectedInnerJoin_tMap_3) {
										count_CPNotFound_tMap_3++;

										CPNotFound_tmp.chargepointkey = 0;
										CPNotFound_tmp.chargepointid = StatusFound.chargepointid;
										CPNotFound_tmp.chargingcapacity = StatusFound.chargingcapacity;
										CPNotFound_tmp.chargertype = StatusFound.chargertype;
										CPNotFound_tmp.installationcost = StatusFound.installationcost;
										CPNotFound_tmp.chargingpointstatuskey = StatusFound.chargingpointstatuskey;
										CPNotFound_tmp.stationkey = StatusFound.stationkey;
										CPNotFound = CPNotFound_tmp;
										log.debug("tMap_3 - Outputting the record " + count_CPNotFound_tMap_3
...
// Start of branch "CPFound"
								if (CPFound != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "CPFound", "tMap_3", "tMap_3", "tMap", "tDBOutput_1", "\"chargingpoint\"",
											"tPostgresqlOutput"
									...
									if (CPFound.chargepointid == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(1, CPFound.chargepointid);
									}

									pstmt_tDBOutput_1.setBigDecimal(2, CPFound.chargingcapacity);

									if (CPFound.chargertype == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, CPFound.chargertype);
									}

									pstmt_tDBOutput_1.setBigDecimal(4, CPFound.installationcost);

									if (CPFound.chargingpointstatuskey == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(5, CPFound.chargingpointstatuskey);
									}

									if (CPFound.stationkey == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(6, CPFound.stationkey);
									}

									pstmt_tDBOutput_1.setInt(7 + count_tDBOutput_1, CPFound.chargepointkey);
									...
									if ((batchSize_tDBOutput_1 > 0)
										...
										try {
											...
											if (log.isDebugEnabled())
												log.debug("tDBOutput_1 - " + ("Executing the ") + ("UPDATE")
														+ (" batch."));
...
// Start of branch "CPNotFound"
								if (CPNotFound != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "CPNotFound", "tMap_3", "tMap_3", "tMap", "tDBOutput_2",
											"\"chargingpoint\"", "tPostgresqlOutput"
									...
									if (log.isTraceEnabled()) {
										log.trace(
												"CPNotFound - " + (CPNotFound == null ? "" : CPNotFound.toLogString()));
									}

									whetherReject_tDBOutput_2 = false;
									if (CPNotFound.chargepointid == null) {
										pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(1, CPNotFound.chargepointid);
									}

									pstmt_tDBOutput_2.setBigDecimal(2, CPNotFound.chargingcapacity);

									if (CPNotFound.chargertype == null) {
										pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(3, CPNotFound.chargertype);
									}

									pstmt_tDBOutput_2.setBigDecimal(4, CPNotFound.installationcost);

									if (CPNotFound.chargingpointstatuskey == null) {
										pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(5, CPNotFound.chargingpointstatuskey);
									}

									if (CPNotFound.stationkey == null) {
										pstmt_tDBOutput_2.setNull(6, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_2.setInt(6, CPNotFound.stationkey);
									}
...
// ###############################      
				log.debug("tMap_3 - Written records count in the table 'CPFound': " + count_CPFound_tMap_3 + ".");
				log.debug("tMap_3 - Written records count in the table 'CPNotFound': " + count_CPNotFound_tMap_3 + ".");
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "CPFound", 2, 0,
						"tMap_3", "tMap_3", "tMap", "tDBOutput_1", "\"chargingpoint\"", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "CPNotFound", 2, 0,
						"tMap_3", "tMap_3", "tMap", "tDBOutput_2", "\"chargingpoint\"", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("QUERY" + " = "
									+ "\"SELECT    \\\"chargingstation\\\".\\\"stationkey\\\",    \\\"chargingstation\\\".\\\"stationid\\\",    \\\"chargingstation\\\".\\\"stationname\\\",    \\\"chargingstation\\\".\\\"citykey\\\",    \\\"chargingstation\\\".\\\"maxchargingpoints\\\",    \\\"chargingstation\\\".\\\"stationstatuskey\\\"  FROM \\\"chargingstation\\\"\"");
							log4jParamters_tDBInput_2.append(" | ");
							...
							log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ", SCHEMA_COLUMN=" + ("stationstatuskey") + "}]");
							log4jParamters_tDBInput_2.append(" | ");
	...
	public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.stationkey == null) ? 0 : this.stationkey.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.stationkey == null) {
				if (other.stationkey != null)
					return false;

			} else if (!this.stationkey.equals(other.stationkey))
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(StatusFound,row4) outputs:(CPFound,CPNotFound)
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_4 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_4.append("DB_VERSION" + " = " + "V9_X");
							log4jParamters_tDBInput_4.append(" | ");
							log4jParamters_tDBInput_4.append("HOST" + " = " + "\"34.56.183.144\"");
							log4jParamters_tDBInput_4.append(" | ");
							log4jParamters_tDBInput_4.append("PORT" + " = " + "\"5432\"");
							log4jParamters_tDBInput_4.append(" | ");
							log4jParamters_tDBInput_4.append("DBNAME" + " = " + "\"ev_station_dw\"");
							log4jParamters_tDBInput_4.append(" | ");
							log4jParamters_tDBInput_4.append("SCHEMA_DB" + " = " + "\"\"");
							log4jParamters_tDBInput_4.append(" | ");
							log4jParamters_tDBInput_4.append("USER" + " = " + "\"postgres\"");
							log4jParamters_tDBInput_4.append(" | ");
							log4jParamters_tDBInput_4.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:xK86UvgcGujROweGzFIBdRKt6GutlR8/jVnWJXLsQsWi8w==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_4.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_4", "\"chargingpoint\"", "tPostgresqlInput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:dB3m6CJ237Cp8tOwl7SelcoQnaJTaqG3Cp9tJXcRARLb4A==");

				String dbPwd_tDBInput_4 = decryptedPassword_tDBInput_4;

				String url_tDBInput_4 = "jdbc:postgresql://" + "34.56.183.144" + ":" + "5432" + "/" + "ev_station_dw";
				...
				log.debug("tDBInput_4 - Connection is set auto commit to 'false'.");
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							row4.chargepointkey = 0;
						} else {

							row4.chargepointkey = rs_tDBInput_4.getInt(1);
							if (rs_tDBInput_4.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_4 < 2) {
							row4.chargepointid = null;
						} else {

							row4.chargepointid = rs_tDBInput_4.getInt(2);
							if (rs_tDBInput_4.wasNull()) {
								row4.chargepointid = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 3) {
							row4.chargingcapacity = null;
						} else {

							row4.chargingcapacity = rs_tDBInput_4.getBigDecimal(3);
							if (rs_tDBInput_4.wasNull()) {
								row4.chargingcapacity = null;
							}
						}
						...
						if (colQtyInRs_tDBInput_4 < 5) {
							row4.installationcost = null;
						} else {

							row4.installationcost = rs_tDBInput_4.getBigDecimal(5);
							if (rs_tDBInput_4.wasNull()) {
								row4.installationcost = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 6) {
							row4.chargingpointstatuskey = null;
						} else {

							row4.chargingpointstatuskey = rs_tDBInput_4.getInt(6);
							if (rs_tDBInput_4.wasNull()) {
								row4.chargingpointstatuskey = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 7) {
							row4.stationkey = null;
						} else {

							row4.stationkey = rs_tDBInput_4.getInt(7);
							if (rs_tDBInput_4.wasNull()) {
								row4.stationkey = null;
							}
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row4", "tDBInput_4", "\"chargingpoint\"", "tPostgresqlInput", "tAdvancedHash_row4",
						...
						row4_HashRow.chargepointkey = row4.chargepointkey;

						row4_HashRow.chargepointid = row4.chargepointid;

						row4_HashRow.chargingcapacity = row4.chargingcapacity;

						row4_HashRow.chargertype = row4.chargertype;

						row4_HashRow.installationcost = row4.installationcost;

						row4_HashRow.chargingpointstatuskey = row4.chargingpointstatuskey;

						row4_HashRow.stationkey = row4.stationkey;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tDBInput_4", "\"chargingpoint\"", "tPostgresqlInput", "tAdvancedHash_row4",
						"tAdvancedHash_row4", "tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final ChargingPointLoad ChargingPointLoadClass = new ChargingPointLoad();

		int exitCode = ChargingPointLoadClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'ChargingPointLoad' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'ChargingPointLoad' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_erFgUJvcEe-5PpigxqfS-w");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T22:56:17.295814Z");
		...
		try {
			...
			java.io.InputStream inContext = ChargingPointLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/chargingpointload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ChargingPointLoad.class.getClassLoader()
		...
		log.info("TalendJob: 'ChargingPointLoad' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : ChargingPointLoad");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'ChargingPointLoad' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 364258 characters generated by Talend Real-time Big Data Platform on the 6
 * November 2024 at 23:56:17 CET
 ************************************************************************************************/