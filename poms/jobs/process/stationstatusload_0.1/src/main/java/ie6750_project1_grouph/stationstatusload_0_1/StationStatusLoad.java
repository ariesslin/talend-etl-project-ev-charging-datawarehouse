...
public class StationStatusLoad implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "StationStatusLoad.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(StationStatusLoad.class);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:UtRkQeZ1FIX3oJjyLwtUNaOanQVomFn4bFdCaqoEBTJrSA==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:mYYwu8QRa/ihxGBQ95UrIJ2kuGiaj9LbkBR34s6ODPdBnQ==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:AtH4g4nrNdGT+cjE7GT79ssv1UKFwcZz+IwuaL/KRy42CQ==")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:msqq8utdbDfGCIDoxel13z6llCxG5FHCkc/LYVyexGXkjw==");
	...
	public static class FoundStruct implements routines.system.IPersistableRow<FoundStruct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"stationstatusid\" = ?,\"statusdescription\" = ? WHERE \"stationstatuskey\" = ?";
					...
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("stationstatuskey") + ", NAME=" + ("\"stationstatuskey\"") + ", SQL="
									+ ("\"nextval('stationstatus_stationstatuskey_seq')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2)
						.append("\" (\"" + "stationstatuskey" + "\",\"stationstatusid\",\"statusdescription\") VALUES ("
								+ "nextval('stationstatus_stationstatuskey_seq')" + ",?,?)");
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"stationstatus\\\".\\\"statusid\\\",    \\\"stationstatus\\\".\\\"statusdescription\\\"  FROM \\\"stationstatus\\\"\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"stationstatus\"", "tPostgresqlInput", "tMap_1", "tMap_1",
								"tMap"
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.stationstatusid = '" +
							// row2HashKey.stationstatusid + "'");
						} // G 071
...
// Start of branch "Found"
						if (Found != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "Found", "tMap_1", "tMap_1", "tMap", "tDBOutput_1", "\"stationstatus\"",
									"tPostgresqlOutput"
							...
							if (Found.stationstatusid == null) {
								...
								pstmt_tDBOutput_1.setInt(1, Found.stationstatusid);
							}
...
// Start of branch "NotFound"
						if (NotFound != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "NotFound", "tMap_1", "tMap_1", "tMap", "tDBOutput_2", "\"stationstatus\"",
									"tPostgresqlOutput"
							...
							if (NotFound.stationstatusid == null) {
								...
								pstmt_tDBOutput_2.setInt(1, NotFound.stationstatusid);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Found", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tDBOutput_1", "\"stationstatus\"", "tPostgresqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "NotFound", 2, 0,
						"tMap_1", "tMap_1", "tMap", "tDBOutput_2", "\"stationstatus\"", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"stationstatus\"", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"stationstatus\"", "tPostgresqlInput", "tAdvancedHash_row2",
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-11-06T23:07:44.846633Z");
		...
		try {
			...
			java.io.InputStream inContext = StationStatusLoad.class.getClassLoader().getResourceAsStream(
					"ie6750_project1_grouph/stationstatusload_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = StationStatusLoad.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : StationStatusLoad");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 174787 characters generated by Talend Real-time Big Data Platform on the 7
 * November 2024 at 00:07:44 CET
 ************************************************************************************************/