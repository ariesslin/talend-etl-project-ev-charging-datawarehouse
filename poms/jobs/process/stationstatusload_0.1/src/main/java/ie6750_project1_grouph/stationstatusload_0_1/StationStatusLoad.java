...
package ie6750_project1_grouph.stationstatusload_0_1;
...
/**
 * Job: StationStatusLoad Purpose: <br>
 * Description:  <br>
 * @author lin.shan1@northeastern.edu
 * @version 8.0.1.20240920_1319-patch
 * @status 
 */
public class StationStatusLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "StationStatusLoad.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(StationStatusLoad.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "StationStatusLoad";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_LpBkoJvcEe-5PpigxqfS-w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				StationStatusLoad.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(StationStatusLoad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:FBMKekRL6PH+doFr+uMITIVN6zivfJ6hnatrNHAAi06aeA==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:40ZFbS2l3RhKZ5QSt73bjJajxws5O1N7BrDDXZuDNFkrLw==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:uT/MSlBMUjh4eQb8/wKaTng/Eoy4WtOrEVbSrw/4Nt5bzg==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FExFQdKRFOP3Vzw02fv0xUHLA9f1xx3Y+D21Yppanp64vw==");
...
public static class FoundStruct implements routines.system.IPersistableRow<FoundStruct> {
    final static byte[] commonByteArrayLock_IE6750_PROJECT1_GROUPH_StationStatusLoad = new byte[0];
    static byte[] commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad.length) {
				if(length < 1024 && commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad.length == 0) {
   					commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad = new byte[1024];
				} else {
   					commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad, 0, length);
			strReturn = new String(commonByteArray_IE6750_PROJECT1_GROUPH_StationStatusLoad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_IE6750_PROJECT1_GROUPH_StationStatusLoad) {
...
NotFoundStruct NotFound = new NotFoundStruct();
	...
	s(currentComponent="tDBOutput_1");
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"stationstatus\"");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"stationstatus\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("stationstatus");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("stationstatus");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"stationstatusid\" = ?,\"statusdescription\" = ? WHERE \"stationstatuskey\" = ?";
 ...
 */
	...
	s(currentComponent="tDBOutput_2");
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"stationstatus\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("stationstatuskey")+", NAME="+("\"stationstatuskey\"")+", SQL="+("\"nextval('stationstatus_stationstatuskey_seq')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"stationstatus\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("stationstatus");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("stationstatus");
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"" + "stationstatuskey" + "\",\"stationstatusid\",\"statusdescription\") VALUES (" + "nextval('stationstatus_stationstatuskey_seq')" + ",?,?)");
 ...
 */
	...
	s(currentComponent="tDBInput_1");
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"stationstatus\\\".\\\"statusid\\\",    \\\"stationstatus\\\".\\\"statusdescription\\\"  FROM \\\"stationstatus\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "\"stationstatus\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  \"stationstatus\".\"statusid\", \n  \"stationstatus\".\"statusdescription\"\n FROM \"stationstatus\"";
 ...
 */
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","\"stationstatus\"","tPostgresqlInput","tMap_1","tMap_1","tMap"
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.stationstatusid = row1.statusid ;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.stationstatusid = '" + row2HashKey.stationstatusid + "'");
								} // G 071
...
Found_tmp.stationstatuskey = row2.stationstatuskey;
Found_tmp.stationstatusid = row2.stationstatusid;
...
NotFound_tmp.stationstatuskey = 0;
NotFound_tmp.stationstatusid = row1.statusid ;
...
if(Found != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found","tMap_1","tMap_1","tMap","tDBOutput_1","\"stationstatus\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    if(Found.stationstatusid == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, Found.stationstatusid);
}
...
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
                    ...
                    pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, Found.stationstatuskey);
...
if(NotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tDBOutput_2","\"stationstatus\"","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    if(NotFound.stationstatusid == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, NotFound.stationstatusid);
}
...
// ###############################      
				...
				log.debug("tMap_1 - Written records count in the table 'NotFound': " + count_NotFound_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","\"stationstatus\"","tPostgresqlInput","tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Found",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_1","\"stationstatus\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"NotFound",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_2","\"stationstatus\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"StationStatus Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","StationStatus Load is done!","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("StationStatus Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "StationStatus Load is done!"); 
 ...
 */
	...
	s(currentComponent="tDBInput_2");
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    \\\"stationstatus\\\".\\\"stationstatuskey\\\",    \\\"stationstatus\\\".\\\"stationstatusid\\\",    \\\"stationstatus\\\".\\\"statusdescription\\\"  FROM \\\"stationstatus\\\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("stationstatuskey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("stationstatusid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("statusdescription")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_2", "\"stationstatus\"", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row2.stationstatuskey = 0;
							} else {
		                          
            row2.stationstatuskey = rs_tDBInput_2.getInt(1);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row2.stationstatusid = null;
							} else {
		                          
            row2.stationstatusid = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    row2.stationstatusid = null;
            }
		                    }
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"stationstatus\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
				...
				row2_HashRow.stationstatusid = row2.stationstatusid;
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"stationstatus\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final StationStatusLoad StationStatusLoadClass = new StationStatusLoad();

        int exitCode = StationStatusLoadClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'StationStatusLoad' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'StationStatusLoad' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_LpBkoJvcEe-5PpigxqfS-w");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:04.440935Z");
        ...
        try {
            ...
            java.io.InputStream inContext = StationStatusLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/stationstatusload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = StationStatusLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'StationStatusLoad' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : StationStatusLoad");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'StationStatusLoad' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     179738 characters generated by Talend Real-time Big Data Platform 
