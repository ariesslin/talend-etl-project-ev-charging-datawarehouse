...
public class TimeLoad implements TalendJob {
	static {System.setProperty("TalendJob.log", "TimeLoad.log");}
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_gnHIIJvcEe-5PpigxqfS-w", "0.1");
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:8VCOL2FI8cowDYaPEDE3YCqwD0Y1apB+h9ZlZg/q/RLb1g==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:A405Eakd+rdK0qDdR2SuW4yot/gRn9i5wTqxT21wTi+Rgw==");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:hNXNGRz5qLJ6aFg/7oXgim2Q1QdWBCqBSzWs7HXIhzrFeA==").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ThpDsOPCgmFuc87UwhZ+P96PKQgwpErR4+9YOaknDAa4uQ==");
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_1", "4gvnSy_");
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"year\" = ?,\"month\" = ?,\"date\" = ?,\"hour\" = ?,\"daypart\" = ?,\"weekdayorweekend\" = ? WHERE \"timekey\" = ?";
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"timekey\",\"year\",\"month\",\"date\",\"hour\",\"daypart\",\"weekdayorweekend\") VALUES (?,?,?,?,?,?,?)");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"/Users/ariesslin/Downloads/Time.csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TimeKey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("Hour")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("Date")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("Month")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("Year")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("Daypart")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("WeekdayOrWeekend")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"/Users/ariesslin/Downloads/Time.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.TimeKey = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"TimeKey", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Date", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
...
if(row1 != null) { 
	...
	s(currentComponent="tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tFileInputDelimited_1","PrepopulatedTime","tFileInputDelimited","tMap_1","tMap_1","tMap"
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.timekey = '" + row2HashKey.timekey + "'");
								} // G 071
...
if(Found != null) { 
	...
	s(currentComponent="tDBOutput_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found","tMap_1","tMap_1","tMap","tDBOutput_1","\"timedimension\"","tPostgresqlOutput"
...
} else {pstmt_tDBOutput_1.setInt(1, Found.year);
}

                    if(Found.month == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, Found.month);
}
...
} else {pstmt_tDBOutput_1.setInt(4, Found.hour);
}

                    if(Found.daypart == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, Found.daypart);
}

                    if(Found.weekdayorweekend == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, Found.weekdayorweekend);
}
...
if(NotFound != null) { 
	...
	s(currentComponent="tDBOutput_2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tDBOutput_2","\"timedimension\"","tPostgresqlOutput"
...
} else {pstmt_tDBOutput_2.setInt(2, NotFound.year);
}

                    if(NotFound.month == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(3, NotFound.month);
}
...
} else {pstmt_tDBOutput_2.setInt(5, NotFound.hour);
}

                    if(NotFound.daypart == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, NotFound.daypart);
}

                    if(NotFound.weekdayorweekend == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, NotFound.weekdayorweekend);
}
...
// ###############################      
				...
				log.debug("tMap_1 - Written records count in the table 'NotFound': " + count_NotFound_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tFileInputDelimited_1","PrepopulatedTime","tFileInputDelimited","tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Found",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_1","\"timedimension\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"NotFound",2,0,
			 			"tMap_1","tMap_1","tMap","tDBOutput_2","\"timedimension\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"Time Load is done!\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Time Load is done!","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("Time Load is done!")  + (". Code: ")  + (200) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "Time Load is done!"); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"timedimension\\\".\\\"timekey\\\",    \\\"timedimension\\\".\\\"year\\\",    \\\"timedimension\\\".\\\"month\\\",    \\\"timedimension\\\".\\\"date\\\",    \\\"timedimension\\\".\\\"hour\\\",    \\\"timedimension\\\".\\\"daypart\\\",    \\\"timedimension\\\".\\\"weekdayorweekend\\\"  FROM \\\"timedimension\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("timekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("year")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("month")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("date")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("hour")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("daypart")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("weekdayorweekend")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
 ...
 */
	...
	s(currentComponent="tAdvancedHash_row2");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_1","\"timedimension\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_1","\"timedimension\"","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'TimeLoad' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-09T19:56:04.904325Z");
        ...
        try {
            ...
            java.io.InputStream inContext = TimeLoad.class.getClassLoader().getResourceAsStream("ie6750_project1_grouph/timeload_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TimeLoad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     227904 characters generated by Talend Real-time Big Data Platform 
